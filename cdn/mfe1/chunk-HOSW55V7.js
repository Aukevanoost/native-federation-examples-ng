...
var D = class {
    addToWindow(o) {
        l.getAngularTestability = (n, r = !0) => {
            let i = o.findTestabilityInTree(n, r);
            if (i == null)
                throw new U(5103, !1);
            return i;
        }, l.getAllAngularTestabilities = () => o.getAllTestabilities(), l.getAllAngularRootElements = () => o.getAllRootElements();
        let e = n => { let r = l.getAllAngularTestabilities(), i = r.length, a = function () { i--, i == 0 && n(); }; r.forEach(u => { u.whenStable(a); }); };
        l.frameworkStabilizers || (l.frameworkStabilizers = []), l.frameworkStabilizers.push(e);
    }
    findTestabilityInTree(o, e, n) {
        if (e == null)
            return null;
        let r = o.getTestability(e);
        return r ?? (n ? O().isShadowRoot(e) ? this.findTestabilityInTree(o, e.host, !0) : this.findTestabilityInTree(o, e.parentElement, !0) : null);
    }
}, $ = (() => {
    class t {
    ...
    return t;
})(), w = ["alt", "control", "meta", "shift"], te = { "\b": "Backspace", "\t": "Tab", "\x7F": "Delete", "\x1B": "Escape", Del: "Delete", Esc: "Escape", Left: "ArrowLeft", Right: "ArrowRight", Up: "ArrowUp", Down: "ArrowDown", Menu: "ContextMenu", Scroll: "ScrollLock", Win: "OS" }, ne = { alt: t => t.altKey, control: t => t.ctrlKey, meta: t => t.metaKey, shift: t => t.shiftKey }, re = (() => {
    class t extends E {
        constructor(e) { super(e); }
        ...
        static parseEventName(e) {
            ...
            if (n.length === 0 || !(r === "keydown" || r === "keyup"))
                return null;
            let i = t._normalizeKey(n.pop()), a = "", u = n.indexOf("code");
            if (u > -1 && (n.splice(u, 1), a = "code."), w.forEach(T => { let M = n.indexOf(T); M > -1 && (n.splice(M, 1), a += T + "."); }), a += i, n.length != 0 || i.length === 0)
                return null;
            let f = {};
            return f.domEventName = r, f.fullKey = a, f;
        }
        static matchEventFullKeyCode(e, n) {
            let r = te[e.key] || e.key, i = "";
            return n.indexOf("code.") > -1 && (r = e.code, i = "code."), r == null || !r ? !1 : (r = r.toLowerCase(), r === " " ? r = "space" : r === "." && (r = "dot"), w.forEach(a => {
                if (a !== r) {
                    let u = ne[a];
                    u(e) && (i += a + ".");
                }
...
var k = [{ provide: v, useClass: D }, { provide: Y, useClass: R, deps: [h, b, v] }, { provide: R, useClass: R, deps: [h, b, v] }], F = [{ provide: z, useValue: "root" }, { provide: _, useFactory: ie }, { provide: p, useClass: ee, multi: !0, deps: [d] }, { provide: p, useClass: re, multi: !0, deps: [d] }, m, I, A, { provide: Z, useExisting: m }, { provide: j, useClass: $ }, []], De = (() => {
    class t {
        constructor() { }
        static ɵfac = function (n) { return new (n || t); };
