...
var Or = {}, U = [], J = new g(""), tn = new g("", -1), rn = new g(""), W = class {
    get(n, t = T) {
        if (t === T)
            throw new Pn(`NullInjectorError: No provider for ${y(n)}!`);
        return t;
    }
};
...
var O = class {
    ...
    get(n, t = T, r) {
        if (j(this), n.hasOwnProperty(We))
            return n[We](this);
        let o = G(r), i, u = E(this), c = D(void 0);
        try {
            if (!(o & 4)) {
    ...
    resolveInjectorInitializers() {
        let n = N(null), t = E(this), r = D(void 0), o;
        try {
    ...
    processProvider(n) {
        n = m(n);
        let t = de(n) ? n : m(n && n.provide), r = mt(n);
        if (!de(n) && n.multi === !0) {
...
function le(e) {
    let n = Y(e), t = n !== null ? n.factory : B(e);
    if (t !== null)
        return t;
    if (e instanceof g)
        throw new f(204, !1);
...
function Ar(e, n) {
    let t;
    e instanceof z ? (j(e), t = e) : t = new ue(e);
    let r, o = E(t), i = D(void 0);
    try {
        return n();
    }
    finally {
...
function Q(e) {
    e[fn].changeDetectionScheduler?.notify(0);
    let n = Je(e);
    for (; n !== null && !(n[p] & 8192 || (n[p] |= 8192, !vn(n)));)
        n = Je(n);
}
function Ot(e, n) {
    if (gn(e))
...
}, wn = new g("", { providedIn: "root", factory: () => { let e = h(O), n; return t => { e.destroyed && !n ? setTimeout(() => { throw t; }) : (n ??= e.get(_), n.handleError(t)); }; } }), yi = { provide: J, useValue: () => void h(_), multi: !0 }, zt = new g("", { providedIn: "root", factory: () => {
        if (typeof ngServerMode < "u" && ngServerMode)
            return;
        let e = h(Ut).defaultView;
        if (!e)
            return;
        let n = h(wn), t = i => { n(i.reason), i.preventDefault(); }, r = i => { i.error ? n(i.error) : n(new Error(i.message, { cause: i })), i.preventDefault(); }, o = () => { e.addEventListener("unhandledrejection", t), e.addEventListener("error", r); };
        typeof Zone < "u" ? Zone.root.run(o) : o(), h(R).onDestroy(() => { e.removeEventListener("error", r), e.removeEventListener("unhandledrejection", t); });
    } });
...
var Rn = $(V({}, je), { consumerIsAlwaysLive: !0, consumerAllowSignalWrites: !0, dirty: !0, hasRun: !1, cleanupFns: void 0, zone: null, kind: "effect", onDestroyFn: Nn, run() {
        if (this.dirty = !1, this.hasRun && !Pe(this))
            return;
        this.hasRun = !0;
        let e = r => (this.cleanupFns ??= []).push(r), n = Oe(this), t = Te(!1);
        try {
...
var xe = class {
    ...
    destroyed = !1;
    unregisterOnDestroy;
    constructor(n, t, r, o, i, u = bn) {
        super(k(() => {
            let c = this.state().stream?.();
            if (!c || this.state().status === "loading" && this.error())
                return r;
            if (!_e(c)) {
                if (u)
            ...
            return c.value;
        }, { equal: o })), this.loaderFn = t, this.equal = o, this.extRequest = Mn({ source: n, computation: c => ({ request: c, reload: 0 }) }), this.state = Mn({ source: this.extRequest, computation: (c, a) => { let l = c.request === void 0 ? "idle" : "loading"; return a ? { extRequest: c, status: l, previousStatus: Fn(a.value), stream: a.value.extRequest.request === c.request ? a.value.stream : void 0 } : { extRequest: c, status: l, previousStatus: "idle", stream: void 0 }; } }), this.effectRef = Qt(this.loadEffect.bind(this), { injector: i, manualCleanup: !0 }), this.pendingTasks = i.get(Tn), this.unregisterOnDestroy = i.get(R).onDestroy(() => this.destroy());
    }
    ...
    set(n) {
        if (this.destroyed)
            return;
        let t = I(this.error), r = I(this.state);
        if (!t) {
            let o = I(this.value);
    ...
    loadEffect() {
        return X(this, null, function* () {
            let n = this.extRequest(), { status: t, previousStatus: r } = I(this.state);
            if (n.request === void 0)
                return;
            if (t !== "loading")
                return;
...
function or(e) {
    return ir(e) ? e.stream : n => X(null, null, function* () {
        try {
