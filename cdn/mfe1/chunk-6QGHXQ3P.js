...
var $ = new N(""), Z = (() => {
    class o {
        ...
        _findPluginFor(e) {
            ...
            if (t)
                return t;
            if (t = this._plugins.find(r => r.supports(e)), !t)
                throw new M(5101, !1);
...
function F(o, n, e, t) {
    let s = o.head?.querySelectorAll(`style[${S}="${n}"],link[${S}="${n}"]`);
    if (s)
        for (let r of s)
...
var G = (() => {
    class o {
        ...
        addStyles(e, t) {
            for (let s of e)
                this.addUsage(s, this.inline, P);
            t?.forEach(s => this.addUsage(s, this.external, C));
        }
        removeStyles(e, t) {
            for (let s of e)
                this.removeUsage(s, this.inline);
            t?.forEach(s => this.removeUsage(s, this.external));
        }
        ...
        addHost(e) {
            ...
            for (let [t, { elements: s }] of this.inline)
                s.push(this.addElement(e, P(t, this.doc)));
    ...
    return o;
})(), E = { svg: "http://www.w3.org/2000/svg", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/", math: "http://www.w3.org/1998/Math/MathML" }, A = /%COMP%/g;
...
var ne = (() => {
    class o {
        ...
        createRenderer(e, t) {
            ...
            typeof ngServerMode < "u" && ngServerMode && t.encapsulation === m.ShadowDom && (t = _(D({}, t), { encapsulation: m.Emulated }));
            let s = this.getOrCreateRenderer(e, t);
            return s instanceof w ? s.applyToHost(e) : s instanceof y && s.applyStyles(), s;
        }
        getOrCreateRenderer(e, t) {
            let s = this.rendererByCompId, r = s.get(t.id);
            if (!r) {
    ...
    listen(n, e, t, s) {
        if (typeof n == "string" && (n = k().getGlobalEventTarget(this.doc, n), !n))
            throw new M(5102, !1);
        let r = this.decoratePreventDefault(t);
        return this.tracingService?.wrapEventListener && (r = this.tracingService.wrapEventListener(n, e, r)), this.eventManager.addEventListener(n, e, r, s);
    }
...
var O = class extends g {
    ...
    hostEl;
    shadowRoot;
    constructor(n, e, t, s, r, a, l, h, c) {
        super(n, r, a, h, c), this.sharedStylesHost = e, this.hostEl = t, this.shadowRoot = t.attachShadow({ mode: "open" }), this.sharedStylesHost.addHost(this.shadowRoot);
        let d = s.styles;
        d = j(s.id, d);
        for (let f of d) {
