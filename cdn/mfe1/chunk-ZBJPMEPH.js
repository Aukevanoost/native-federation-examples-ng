...
var t = null, v = !1, R = 1, D = null, h = Symbol("SIGNAL");
...
function O(e) {
    ...
    if (y(t), r < t.producerNode.length && t.producerNode[r] !== e && N(t)) {
...
function G() { R++; }
function d(e) {
    if (!(N(e) && !e.dirty) && !(!e.dirty && e.lastCleanEpoch === R)) {
...
function g(e) { e.dirty = !1, e.lastCleanEpoch = R; }
function M(e) { return e && (e.nextProducerIndex = 0), a(e); }
function w(e, r) {
    if (a(r), !(!e || e.producerNode === void 0 || e.producerIndexOfThis === void 0 || e.producerLastReadVersion === void 0)) {
        if (N(e))
...
function X(e) {
    if (y(e), N(e))
        for (let r = 0; r < e.producerNode.length; r++)
            E(e.producerNode[r], e.producerIndexOfThis[r]);
...
function b(e, r, u) {
    if (L(e), e.liveConsumerNode.length === 0 && k(e))
        for (let n = 0; n < e.producerNode.length; n++)
            e.producerIndexOfThis[n] = b(e.producerNode[n], e, n);
    return e.liveConsumerIndexOfThis.push(u), e.liveConsumerNode.push(r) - 1;
}
function E(e, r) {
    if (L(e), e.liveConsumerNode.length === 1 && k(e))
        for (let n = 0; n < e.producerNode.length; n++)
            E(e.producerNode[n], e.producerIndexOfThis[n]);
    ...
    if (e.liveConsumerNode[r] = e.liveConsumerNode[u], e.liveConsumerIndexOfThis[r] = e.liveConsumerIndexOfThis[u], e.liveConsumerNode.length--, e.liveConsumerIndexOfThis.length--, r < e.liveConsumerNode.length) {
        ...
        y(o), o.producerIndexOfThis[n] = r;
    }
}
function N(e) { return e.consumerIsAlwaysLive || (e?.liveConsumerNode?.length ?? 0) > 0; }
function y(e) { e.producerNode ??= [], e.producerIndexOfThis ??= [], e.producerLastReadVersion ??= []; }
function L(e) { e.liveConsumerNode ??= [], e.liveConsumerIndexOfThis ??= []; }
function k(e) { return e.producerNode !== void 0; }
function x(e) { D?.(e); }
function Y(e) { let r = D; return D = e, r; }
function Z(e, r) {
    let u = Object.create(_);
    u.computation = e, r !== void 0 && (u.equal = r);
    let n = () => {
        if (d(u), O(u), u.value === i)
            throw u.error;
        return u.value;
    };
    return n[h] = u, x(u), n;
}
var c = Symbol("UNSET"), l = Symbol("COMPUTING"), i = Symbol("ERRORED"), _ = m(p({}, S), { value: c, dirty: !0, error: null, equal: I, kind: "computed", producerMustRecompute(e) { return e.value === c || e.value === l; }, producerRecomputeValue(e) {
        if (e.value === l)
            throw new Error("");
        let r = e.value;
        e.value = l;
...
function ee(e) { F = e; }
var C = null;
function re(e, r) { let u = Object.create(B); u.value = e, r !== void 0 && (u.equal = r); let n = () => j(u); return n[h] = u, x(u), [n, f => T(u, f), f => P(u, f)]; }
...
function ce(e, r, u) {
    ...
    n.source = e, n.computation = r, u != null && (n.equal = u);
    let s = () => {
        if (d(n), O(n), n.value === i)
            throw n.error;
        return n.value;
    };
    return s[h] = n, x(n), s;
...
var z = m(p({}, S), { value: c, dirty: !0, error: null, equal: I, kind: "linkedSignal", producerMustRecompute(e) { return e.value === c || e.value === l; }, producerRecomputeValue(e) {
        if (e.value === l)
            throw new Error("");
        let r = e.value;
        e.value = l;
...
export { I as a, h as b, a as c, H as d, J as e, Q as f, S as g, O as h, G as i, d as j, V as k, A as l, q as m, g as n, M as o, w as p, $ as q, X as r, x as s, Y as t, Z as u, ee as v, re as w, ne as x, j as y, T as z, P as A, ue as B, B as C, ce as D, se as E, le as F, ae as G }; /*! Bundled license information:
