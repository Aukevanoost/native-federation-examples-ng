...
var oe = typeof navigator < "u" && /iPhone|iPad|iPod/.test(navigator.userAgent), m = class {
    ...
    cleanUp() {
        for (let e = 0; e < this.handlerInfos.length; e++)
            ee(this.element, this.handlerInfos[e]);
        this.handlerInfos = [];
    }
...
var O = class t {
    ...
    populateAction(e, n) {
        let r = n;
        for (; r && r !== b(e) && (r.nodeType === Node.ELEMENT_NODE && this.populateActionOnElement(r, e), !d(e));)
            r = this.getParentNode(r);
        let s = d(e);
        if (s && (this.a11yClickSupport && this.preventDefaultForA11yClick(e), this.syntheticMouseEventSupport && (a(e) === i.MOUSEENTER || a(e) === i.MOUSELEAVE || a(e) === i.POINTERENTER || a(e) === i.POINTERLEAVE)))
            if (ie(h(e), a(e), l(s))) {
                let o = se(h(e), l(s));
                w(e, o), k(e, l(s));
            }
    ...
    dispatch(e) {
        let n = new O(e);
        this.actionResolver?.resolveEventType(e), this.actionResolver?.resolveAction(e);
        let r = n.getAction();
        if (r && fe(r.element, n) && te(n.getEvent()), this.eventReplayer && n.getIsReplay()) {
...
var Oe = "`composedPath` called during event replay.", C = class {
    ...
    dispatchToDelegate(e) {
        for (e.getIsReplay() && Se(e), ge(e); e.getAction();) {
...
var Ce = !1, Le = (() => {
    class t {
        ...
        addEvent(n, r, s) {
            if (n in this.eventHandlers || !this.containerManager || !t.MOUSE_SPECIAL_SUPPORT && $.indexOf(n) >= 0)
                return;
            let o = (E, p, f) => { this.handleEvent(E, p, f); };
