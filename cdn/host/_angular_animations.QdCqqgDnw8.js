import { a as l, b as h, c as p, d as _, e as y, f as c, g as f, h as A, i as g, j as v, k as M, l as D, m as I, n as P, o as w, p as T, q as b, r as E } from "@nf-internal/chunk-VVBHJ7DW";
import "@nf-internal/chunk-4CLCTAJ7";
import { DOCUMENT as j } from "@angular/common";
import * as r from "@angular/core";
import { inject as m, ANIMATION_MODULE_TYPE as x, ɵRuntimeError as R, ViewEncapsulation as N } from "@angular/core";
var k = (() => {
    class t {
    ...
    class t extends k {
        ...
        constructor(n, i) {
            super();
            let s = { id: "0", encapsulation: N.None, styles: [], data: { animation: [] } };
            if (this._renderer = n.createRenderer(i.body, s), this.animationModuleType === null && !$(this._renderer))
                throw new R(3600, !1);
        }
