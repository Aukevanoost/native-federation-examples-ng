import { i as t } from "@nf-internal/chunk-HOSW55V7";
import { f as c } from "@nf-internal/chunk-6QGHXQ3P";
...
var p = [{ provide: g, useFactory: R }, { provide: a, useClass: O }, { provide: v, useFactory: E, deps: [c, a, N] }], d = [{ provide: u, useClass: f }, { provide: m, useValue: "NoopAnimations" }, ...p], s = [{ provide: u, useFactory: () => typeof ngServerMode < "u" && ngServerMode ? new f : new M }, { provide: m, useFactory: () => typeof ngServerMode < "u" && ngServerMode ? "NoopAnimations" : "BrowserAnimations" }, ...p], W = (() => {
    class e {
