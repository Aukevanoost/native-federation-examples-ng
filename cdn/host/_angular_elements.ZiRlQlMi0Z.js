...
function O(n, t) {
    let e = n.childNodes, s = t.map(() => []), r = -1;
    t.some((c, u) => c === "*" ? (r = u, !0) : !1);
...
var k = 10, h = class {
    ...
    inputMap = new Map;
    constructor(t, e) {
        this.componentFactory = e.get(d).resolveComponentFactory(t);
        for (let s of this.componentFactory.inputs)
    ...
    initializeInputs() {
        for (let [t, e] of this.initialInputValues)
...
function L(n, t) {
    let e = x(n, t.injector), s = t.strategyFactory || new h(n, t.injector), r = _(e);
    class c extends m {
        injector;
        ...
        get ngElementStrategy() {
            if (!this._ngElementStrategy) {
                ...
                e.forEach(({ propName: i, transform: a }) => {
                    if (!this.hasOwnProperty(i))
                        return;
                    let f = this[i];
                    delete this[i], o.setInputValue(i, f, a);
                });
            }
