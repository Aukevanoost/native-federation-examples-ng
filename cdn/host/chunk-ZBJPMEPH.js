...
function O(e) { if (v)
    ...
    return; t.consumerOnSignalRead(e); let r = t.nextProducerIndex++; if (y(t), r < t.producerNode.length && t.producerNode[r] !== e && N(t)) {
...
function G() { R++; }
function d(e) { if (!(N(e) && !e.dirty) && !(!e.dirty && e.lastCleanEpoch === R)) {
...
function Z(e, r) { let u = Object.create(_); u.computation = e, r !== void 0 && (u.equal = r); let n = () => { if (d(u), O(u), u.value === i)
    throw u.error; return u.value; }; return n[h] = u, x(u), n; }
var c = Symbol("UNSET"), l = Symbol("COMPUTING"), i = Symbol("ERRORED"), _ = m(p({}, S), { value: c, dirty: !0, error: null, equal: I, kind: "computed", producerMustRecompute(e) { return e.value === c || e.value === l; }, producerRecomputeValue(e) { if (e.value === l)
...
function ce(e, r, u) { let n = Object.create(z); n.source = e, n.computation = r, u != null && (n.equal = u); let s = () => { if (d(n), O(n), n.value === i)
    throw n.error; return n.value; }; return s[h] = n, x(n), s; }
