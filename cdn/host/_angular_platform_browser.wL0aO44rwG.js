import { a as j, b as L, c as U, d as k, e as P, f as z, g as x, h as B, i as Z } from "@nf-internal/chunk-HOSW55V7";
import { a as E, b as H, c as w, d as O, e as N, f as A } from "@nf-internal/chunk-6QGHXQ3P";
...
import { ɵglobal as S, ApplicationRef as $, InjectionToken as D, ɵConsole as ge, Optional as G, Injector as V, ɵRuntimeError as g, SecurityContext as d, ɵallowSanitizationBypassAndThrow as p, ɵunwrapSafeValue as f, ɵ_sanitizeUrl as Y, ɵ_sanitizeHtml as F, ɵbypassSanitizationTrustHtml as J, ɵbypassSanitizationTrustStyle as q, ɵbypassSanitizationTrustScript as X, ɵbypassSanitizationTrustUrl as K, ɵbypassSanitizationTrustResourceUrl as Q, ɵwithI18nSupport as W, ɵwithEventReplay as ee, ɵwithIncrementalHydration as te, makeEnvironmentProviders as ne, ɵwithDomHydration as re, ENVIRONMENT_INITIALIZER as Ee, inject as we, NgZone as Se, ɵZONELESS_ENABLED as Te, ɵformatRuntimeError as Me, Version as oe } from "@angular/core";
...
var y = class {
    ...
    timeChangeDetection(i) {
        let e = i && i.record, n = "Change Detection";
        e && "profile" in console && typeof console.profile == "function" && console.profile(n);
        let r = performance.now(), s = 0;
        for (; s < 5 || performance.now() - r < 500;)
            this.appRef.tick(), s++;
        let c = performance.now();
        e && "profileEnd" in console && typeof console.profileEnd == "function" && console.profileEnd(n);
        let a = (c - r) / s;
        return console.log(`ran ${s} change detection cycles`), console.log(`${a.toFixed(2)} ms per check`), new y(a, s);
    }
}, R = "profiler";
...
var ae = { pan: !0, panstart: !0, panmove: !0, panend: !0, pancancel: !0, panleft: !0, panright: !0, panup: !0, pandown: !0, pinch: !0, pinchstart: !0, pinchmove: !0, pinchend: !0, pinchcancel: !0, pinchin: !0, pinchout: !0, press: !0, pressup: !0, rotate: !0, rotatestart: !0, rotatemove: !0, rotateend: !0, rotatecancel: !0, swipe: !0, swipeleft: !0, swiperight: !0, swipeup: !0, swipedown: !0, tap: !0, doubletap: !0 }, v = new D(""), I = new D(""), ce = (() => {
    class t {
        events = [];
        overrides = {};
        options;
        buildHammer(e) {
            let n = new Hammer(e, this.options);
            n.get("pinch").set({ enable: !0 }), n.get("rotate").set({ enable: !0 });
            for (let r in this.overrides)
                n.get(r).set(this.overrides[r]);
            return n;
        }
        ...
        addEventListener(e, n, r) {
            ...
            if (n = n.toLowerCase(), !window.Hammer && this.loader) {
                ...
                return s.runOutsideAngular(() => this._loaderPromise.then(() => {
                    ...
                    c || (a = this.addEventListener(e, n, r));
                }).catch(() => { a = () => { }; })), () => { a(); };
            }
    ...
    class t {
        ...
        static ɵinj = o.ɵɵdefineInjector({ providers: [{ provide: E, useClass: ue, multi: !0, deps: [h, v, V, [new G, I]] }, { provide: v, useClass: ce }] });
    }
    return t;
})(), de = (() => {
    class t {
    ...
    return t;
})(), u = function (t) { return t[t.NoHttpTransferCache = 0] = "NoHttpTransferCache", t[t.HttpTransferCacheOptions = 1] = "HttpTransferCacheOptions", t[t.I18nSupport = 2] = "I18nSupport", t[t.EventReplay = 3] = "EventReplay", t[t.IncrementalHydration = 4] = "IncrementalHydration", t; }(u || {});
...
function Le() { return m(u.EventReplay, ee()); }
function Ue() { return m(u.IncrementalHydration, te()); }
function ke(...t) {
    let i = [], e = new Set;
    for (let { ɵproviders: r, ɵkind: s } of t)
        e.add(s), r.length && i.push(r);
    let n = e.has(u.HttpTransferCacheOptions);
    return ne([[], re(), e.has(u.NoHttpTransferCache) || n ? [] : b({}), i]);
}
var Pe = new oe("20.1.0");
