import { f as d } from "@nf-internal/chunk-6QGHXQ3P";
...
var R = "@", I = (() => {
    class i {
        ...
        createRenderer(t, n) {
            ...
            let o = new l(r);
            return n?.data?.animation && !this._rendererFactoryPromise && (this._rendererFactoryPromise = this.loadImpl()), this._rendererFactoryPromise?.then(s => { let c = s.createRenderer(t, n); o.use(c), this.scheduler ??= this.injector.get(m, null, { optional: !0 }), this.scheduler?.notify(10); }).catch(s => { o.use(r); }), o;
        }
