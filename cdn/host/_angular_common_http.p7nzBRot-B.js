import { a as Re, b as be } from "@nf-internal/chunk-ETBWX65U";
...
var M = class e {
    ...
    cloneFrom = null;
    constructor(r = {}) {
        if (this.encoder = r.encoder || new K, r.fromString) {
            if (r.fromObject)
                throw new O(2805, !1);
    ...
    init() {
        this.map === null && (this.map = new Map), this.cloneFrom !== null && (this.cloneFrom.init(), this.cloneFrom.keys().forEach(r => this.map.set(r, this.cloneFrom.map.get(r))), this.updates.forEach(r => {
            switch (r.op) {
                case "a":
                case "s":
...
var z = "Content-Type", q = "Accept", le = "X-Request-URL", Le = "text/plain", Ue = "application/json", Ce = `${Ue}, ${Le}, */*`, x = class e {
    ...
    timeout;
    constructor(r, t, n, s) {
        this.url = t, this.method = r.toUpperCase();
        let i;
        if (Tt(this.method) || s ? (this.body = n !== void 0 ? n : null, i = s) : i = n, i) {
...
var he = (() => {
    class e {
        ...
        request(t, n, s = {}) {
            ...
            let o = je(i).pipe(ut(a => this.handler.handle(a)));
            if (t instanceof x || s.observe === "events")
                return o;
            let c = o.pipe(ht(a => a instanceof A));
            switch (s.observe || "body") {
                case "body": switch (i.responseType) {
                    case "arraybuffer": return c.pipe($(a => {
                        if (a.body !== null && !(a.body instanceof ArrayBuffer))
                            throw new O(2806, !1);
                        return a.body;
                    }));
                    case "blob": return c.pipe($(a => {
                        if (a.body !== null && !(a.body instanceof Blob))
                            throw new O(2807, !1);
                        return a.body;
                    }));
                    case "text": return c.pipe($(a => {
    ...
    class e {
        ...
        doRequest(t, n, s) {
            return te(this, null, function* () {
                let i = this.createRequestInit(t), o;
                try {
                ...
                let c = new R(o.headers), a = o.statusText, p = Ae(o) ?? t.urlWithParams, g = o.status, m = null;
                if (t.reportProgress && s.next(new X({ headers: c, status: g, statusText: a, url: p })), o.body) {
                    let y = o.headers.get("content-length"), d = [], P = o.body.getReader(), l = 0, h, T, N = typeof Zone < "u" && Zone.current, f = !1;
                    if (yield this.ngZone.runOutsideAngular(() => te(this, null, function* () {
                        for (;;) {
                            if (this.destroyed) {
                                yield P.cancel(), f = !0;
                                break;
        ...
        createRequestInit(t) {
            let n = {}, s;
            if (s = t.credentials, t.withCredentials && (s = "include"), t.headers.forEach((i, o) => n[i] = o.join(",")), t.headers.has(q) || (n[q] = Ce), !t.headers.has(z)) {
...
function Nt() {
    let e = null;
    return (r, t) => {
        e === null && (e = (w(fe, { optional: !0 }) ?? []).reduceRight(bt, ze));
        let n = w(ke);
        if (w(me)) {
            let i = n.add();
...
var Z = (() => {
    ...
    return e;
})(), Mt = 0, Ie, Ot = "JSONP injected script did not invoke callback.";
var Q = class {
};
    ...
    class e {
        ...
        handle(t) {
            ...
            if (t.responseType !== "json")
                throw new O(2811, !1);
            if (t.headers.keys().length > 0)
                throw new O(2812, !1);
            return new de(n => {
                let s = this.nextCallback(), i = t.urlWithParams.replace(/=JSONP_CALLBACK(&|$)/, `=${s}$1`), o = this.document.createElement("script");
                o.src = i;
                let c = null, a = !1;
                this.callbackMap[s] = E => { delete this.callbackMap[s], c = E, a = !0; };
                let p = () => { o.removeEventListener("load", g), o.removeEventListener("error", m), o.remove(), delete this.callbackMap[s]; }, g = () => {
                    this.resolvedPromise.then(() => {
                        if (p(), !a) {
                            n.error(new v({ url: i, status: 0, statusText: "JSONP Error", error: new Error(Ot) }));
                            return;
                        }
                        n.next(new A({ body: c, status: ue, statusText: "OK", url: i })), n.complete();
                    });
                }, m = E => { p(), n.error(new v({ error: E, status: 0, statusText: "JSONP Error", url: i })); };
                return o.addEventListener("load", g), o.addEventListener("error", m), this.document.body.appendChild(o), n.next({ type: b.Sent }), () => { a || this.removeListeners(o), p(); };
            });
        }
...
var ie = (() => {
    class e {
        ...
        handle(t) {
            ...
            return (typeof ngServerMode < "u" && ngServerMode && n.ɵloadImpl ? pt(n.ɵloadImpl()) : je(null)).pipe(ft(() => new de(i => {
                let o = n.build();
                if (o.open(t.method, t.urlWithParams), t.withCredentials && (o.withCredentials = !0), t.headers.forEach((l, h) => o.setRequestHeader(l, h.join(","))), t.headers.has(q) || o.setRequestHeader(q, Ce), !t.headers.has(z)) {
                ...
                let c = t.serializeBody(), a = null, p = () => {
                    if (a !== null)
                        return a;
                    let l = o.statusText || "OK", h = new R(o.getAllResponseHeaders()), T = kt(o) || t.url;
                    return a = new X({ headers: h, status: o.status, statusText: l, url: T }), a;
                }, g = () => {
                    let { headers: l, status: h, statusText: T, url: N } = p(), f = null;
                    h !== wt && (f = typeof o.response > "u" ? o.responseText : o.response), h === 0 && (h = f ? ue : 0);
                    let _ = h >= 200 && h < 300;
                    if (t.responseType === "json" && typeof f == "string") {
                        let k = f;
                        f = f.replace(Dt, "");
                        try {
                    ...
                    _ ? (i.next(new A({ body: f, headers: l, status: h, statusText: T, url: N || void 0 })), i.complete()) : i.error(new v({ error: f, headers: l, status: h, statusText: T, url: N || void 0 }));
                }, m = l => { let { url: h } = p(), T = new v({ error: l, status: o.status || 0, statusText: o.statusText || "Unknown Error", url: h || void 0 }); i.error(T); }, E = m;
                t.timeout && (E = l => { let { url: h } = p(), T = new v({ error: new DOMException("Request timed out", "TimeoutError"), status: o.status || 0, statusText: o.statusText || "Request timeout", url: h || void 0 }); i.error(T); });
                let y = !1, d = l => { y || (i.next(p()), y = !0); let h = { type: b.DownloadProgress, loaded: l.loaded }; l.lengthComputable && (h.total = l.total), t.responseType === "text" && o.responseText && (h.partialText = o.responseText), i.next(h); }, P = l => { let h = { type: b.UploadProgress, loaded: l.loaded }; l.lengthComputable && (h.total = l.total), i.next(h); };
                return o.addEventListener("load", g), o.addEventListener("error", m), o.addEventListener("timeout", E), o.addEventListener("abort", m), t.reportProgress && (o.addEventListener("progress", d), c !== null && o.upload && o.upload.addEventListener("progress", P)), o.send(c), i.next({ type: b.Sent }), () => { o.removeEventListener("error", m), o.removeEventListener("abort", m), o.removeEventListener("load", g), o.removeEventListener("timeout", E), t.reportProgress && (o.removeEventListener("progress", d), c !== null && o.upload && o.upload.removeEventListener("progress", P)), o.readyState !== o.DONE && o.abort(); };
            })));
        }
    ...
    return e;
})(), H = new I(""), Je = "XSRF-TOKEN", Ve = new I("", { providedIn: "root", factory: () => Je }), $e = "X-XSRF-TOKEN", Ge = new I("", { providedIn: "root", factory: () => $e }), C = class {
}, We = (() => {
    class e {
        doc;
        cookieName;
        ...
        getToken() {
            ...
            return t !== this.lastCookieString && (this.parseCount++, this.lastToken = Re(t, this.cookieName), this.lastCookieString = t), this.lastToken;
        }
...
function Ke(e, r) {
    ...
    if (!w(H) || e.method === "GET" || e.method === "HEAD" || t.startsWith("http://") || t.startsWith("https://"))
        return r(e);
    let n = w(C).getToken(), s = w(Ge);
    return n != null && !e.headers.has(s) && (e = e.clone({ headers: e.headers.set(s, n) })), r(e);
}
var De = (() => {
    class e {
        injector;
    ...
    return e;
})(), D = function (e) { return e[e.Interceptors = 0] = "Interceptors", e[e.LegacyInterceptors = 1] = "LegacyInterceptors", e[e.CustomXsrfConfiguration = 2] = "CustomXsrfConfiguration", e[e.NoXsrfProtection = 3] = "NoXsrfProtection", e[e.JsonpSupport = 4] = "JsonpSupport", e[e.RequestsMadeViaParent = 5] = "RequestsMadeViaParent", e[e.Fetch = 6] = "Fetch", e; }(D || {});
function L(e, r) { return { ɵkind: e, ɵproviders: r }; }
function Ye(...e) {
    let r = [he, ie, Z, { provide: F, useExisting: Z }, { provide: j, useFactory: () => w(Se, { optional: !0 }) ?? w(ie) }, { provide: J, useValue: Ke, multi: !0 }, { provide: H, useValue: !0 }, { provide: C, useClass: We }];
    for (let t of e)
        r.push(...t.ɵproviders);
    return lt(r);
}
...
function Zt(e, r) {
    ...
    let n = t.headers instanceof R ? t.headers : new R(t.headers), s = t.params instanceof M ? t.params : new M({ fromObject: t.params });
    return new x(t.method ?? "GET", t.url, t.body ?? null, { headers: n, params: s, reportProgress: t.reportProgress, withCredentials: t.withCredentials, keepalive: t.keepalive, cache: t.cache, priority: t.priority, mode: t.mode, redirect: t.redirect, responseType: r, context: t.context, transferCache: t.transferCache, credentials: t.credentials, timeout: t.timeout });
}
var Te = class extends St {
    ...
    constructor(r, t, n, s, i) {
        super(t, ({ params: o, abortSignal: c }) => {
            let a, p = () => a.unsubscribe();
            c.addEventListener("abort", p);
            let g = Xt({ value: void 0 }), m, E = new Promise(d => m = d), y = d => { g.set(d), m?.(g), m = void 0; };
            return a = this.client.request(o).subscribe({ next: d => {
                    switch (d.type) {
                        case b.Response:
                ...
                }, error: d => { d instanceof v && (this._headers.set(d.headers), this._statusCode.set(d.status)), y({ error: d }), c.removeEventListener("abort", p); }, complete: () => { m && y({ error: new it(991, !1) }), c.removeEventListener("abort", p); } }), E;
        }, n, i, r), this.client = r.get(he);
    }
}, Qt = new at(""), He = "b", et = "h", tt = "s", rt = "st", nt = "u", st = "rt", Ee = new at(""), Ht = ["GET", "HEAD"];
function er(e, r) {
    let y = B(Ee), { isCacheActive: t } = y, n = ve(y, ["isCacheActive"]), { transferCache: s, method: i } = e;
    if (!t || s === !1 || i === "POST" && !n.includePostRequests && !s || i !== "POST" && !Ht.includes(i) || !n.includeRequestsWithAuthHeaders && tr(e) || n.filter?.(e) === !1)
        return r(e);
    let o = B(Wt), c = B(Qt, { optional: !0 });
    if (typeof ngServerMode < "u" && !ngServerMode && c)
        throw new it(2803, !1);
    let a = typeof ngServerMode < "u" && ngServerMode && c ? or(e.url, c) : e.url, p = nr(e, a), g = o.get(p, null), m = n.includeHeaders;
    if (typeof s == "object" && s.includeHeaders && (m = s.includeHeaders), g) {
    ...
    let E = r(e);
    return typeof ngServerMode < "u" && ngServerMode ? E.pipe(qt(d => { d instanceof A && o.set(p, { [He]: d.body, [et]: rr(d.headers, m), [tt]: d.status, [rt]: d.statusText, [nt]: a, [st]: e.responseType }); })) : E;
}
...
function sr(e) {
    let r = 0;
    for (let t of e)
        r = Math.imul(31, r) + t.charCodeAt(0) << 0;
