...
function Yo(e, t, n, o, r) {
    return Ge(() => {
        ...
        function s(...a) {
            ...
            let c = new s(...a);
            return function (u) { return r && r(u, ...a), (u.hasOwnProperty(fn) ? u[fn] : Object.defineProperty(u, fn, { value: [] })[fn]).push(c), u; };
        }
...
function Fn(e, t, n) {
    return Ge(() => {
        ...
        function r(...i) {
            ...
            function a(c, l, u) {
                let d = c.hasOwnProperty(pn) ? c[pn] : Object.defineProperty(c, pn, { value: [] })[pn];
                for (; d.length <= u;)
                    d.push(null);
    ...
    return Ge(() => {
        ...
        function i(...s) {
            ...
            function c(l, u) {
                ...
                let d = l.constructor, f = d.hasOwnProperty(hn) ? d[hn] : Object.defineProperty(d, hn, { value: {} })[hn];
                f[u] = f.hasOwnProperty(u) && f[u] || [], f[u].unshift(a);
            }
            return c;
        }
...
var yi = class {
    ...
    _zipTypesAndAnnotations(t, n) {
        let o;
        typeof t > "u" ? o = ao(n.length) : o = ao(t.length);
        for (let r = 0; r < o.length; r++)
            typeof t > "u" ? o[r] = [] : t[r] && t[r] != Object ? o[r] = [t[r]] : o[r] = [], n && n[r] != null && (o[r] = o[r].concat(n[r]));
        return o;
    }
    _ownParameters(t, n) {
        let o = t.toString();
        ...
        let i = t.hasOwnProperty(pn) && t[pn], s = this._reflect && this._reflect.getOwnMetadata && this._reflect.getOwnMetadata("design:paramtypes", t);
        return s || i ? this._zipTypesAndAnnotations(s, i) : ao(t.length);
    }
    parameters(t) {
        if (!To(t))
            return [];
        let n = Xr(t), o = this._ownParameters(t, n);
    ...
    annotations(t) {
        if (!To(t))
            return [];
        let n = Xr(t), o = this._ownAnnotations(t, n) || [];
    ...
    propMetadata(t) {
        ...
        return r && Object.keys(r).forEach(i => { let s = []; o.hasOwnProperty(i) && s.push(...o[i]), s.push(...r[i]), o[i] = s; }), o;
    }
...
function ch(e, t, n, o) {
    let r = o !== void 0 ? e[on] & 65535 : 0, i = o ?? -1, s = t.length - 1, a = 0;
    for (let c = r; c < s; c++)
...
function Ci(e, t) {
    ...
    let r = Rl(e, t), i = e.injectorIndex;
    if (dh(r)) {
...
function li(e, t, n, o, r) {
    let i = e.providerIndexes, s = t.data, a = i & 1048575, c = e.directiveStart, l = e.directiveEnd, u = i >> 20, d = o ? a : a + u, f = r ? a + u : l;
    for (let p = d; p < f; p++) {
        let h = s[p];
...
function TC(e) {
    ...
    return typeof t == "number" ? t >= 0 ? t & fh : MC : t;
}
...
function Ih(e) {
    return Ge(() => {
        let t = e.prototype.constructor, n = t[lt] || Sc(t), o = Object.prototype, r = Object.getPrototypeOf(e.prototype).constructor;
        for (; r && r !== o;) {
            let i = r[lt] || Sc(r);
            if (i && i !== n)
                return i;
...
function _C(e, t, n, o, r) {
    let i = e, s = t;
    for (; i !== null && s !== null && s[b] & 2048 && !He(s);) {
...
function NC(e) {
    ...
    if (Array.isArray(e) && e.length > 0)
        ...
        e === void 0 || Array.isArray(e) && e.length === 0 ? t.token = null : t.token = e;
    return t;
}
function wC(e, t) {
    let n = null, o = null;
    e.hasOwnProperty(wr) || Object.defineProperty(e, wr, { get: () => (n === null && (n = J({ usage: 0, kind: "injectable", type: e }).compileInjectable($f, `ng:///${e.name}/\u0275prov.js`, kC(e, t))), n) }), e.hasOwnProperty(lt) || Object.defineProperty(e, lt, { get: () => {
            if (o === null) {
...
function Jf(e, t) {
    let n = e[y];
    for (let o = I; o < n.bindingStartIndex; o++)
        if (k(e[o]) === t)
            return o;
    return -1;
}
...
function zC(e) {
    let t = me(e), n = t ? t.lView : null;
    if (n === null)
        return null;
    let o;
    for (; n[y].type === 2 && (o = Pt(n));)
        n = o;
    return He(n) ? null : n[L];
}
function QC(e) {
    let t = me(e), n = t ? t.lView : null;
    if (n === null)
        return Ce.NULL;
    let o = n[y].data[t.nodeIndex];
    return new Et(o, n);
}
function ZC(e) {
    let t = me(e), n = t ? t.lView : null;
    if (n === null)
        return [];
    let o = n[y], r = o.data[t.nodeIndex], i = [], s = r.providerIndexes & 1048575, a = r.directiveEnd;
    for (let c = s; c < a; c++) {
        let l = o.data[c];
...
function YC(e) {
    ...
    if (n === null)
        return [];
    let o = n[y], r = t.nodeIndex;
    return o?.data[r] ? (t.directives === void 0 && (t.directives = Sh(r, n)), t.directives === null ? [] : [...t.directives]) : [];
}
...
function XC(e) {
    let t = me(e), n = t === null ? null : t.lView;
    if (n === null)
        return [];
    let o = n[y], r = n[kt], i = o.cleanup, s = [];
    if (i && r)
...
function Bl(e, t, n = null) {
    if (t.length === 0 || e.nodeType !== Node.ELEMENT_NODE)
        return;
    let o = e.getAttribute(Jr.JSACTION), r = t.reduce((s, a) => (o?.indexOf(a) ?? -1) === -1 ? s + a + ":;" : s, "");
    e.setAttribute(Jr.JSACTION, `${o ?? ""}${r}`);
    let i = n ?? "";
    i !== "" && r.length > 0 && e.setAttribute(Un, i);
}
...
var nt = new w(""), qh = (() => {
    class e {
        ...
        contract = D(Gl);
        add(n, o) {
            if (this.registry.set(n, o), this.awaitingCallbacks.has(n)) {
        ...
        cleanup(n) {
            gT(n, this.jsActionMap);
            for (let o of n)
                this.registry.delete(o), this.jsActionMap.delete(o), this.invokeTriggerCleanupFns(o), this.hydrating.delete(o), this.awaitingCallbacks.delete(o);
...
function IT(e, t, n = !1) {
    ...
    return n && (l.firstChild = e, is(l, 0, e.nextSibling)), a ? e.setAttribute(En, a) : e.removeAttribute(En), l;
}
function Zh() { Qh = IT; }
...
function DT(e) {
    let t = Mt(), n = t.createNodeIterator(e, NodeFilter.SHOW_COMMENT, { acceptNode(i) { let s = ET(i); return s === "ngetn" || s === "ngtns" ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT; } }), o, r = [];
    for (; o = n.nextNode();)
        r.push(o);
    for (let i of r)
...
function _T(e, t) {
    let n = t.get(nt), r = t.get(Zt).get(rs, {}), i = !1, s = e, a = null, c = [];
    for (; !i && s;) {
        i = n.has(s);
...
function NT(e) {
    let t = e.body.querySelectorAll("[jsaction]"), n = new Set, o = [wi.join(":;"), Ni.join(":;")].join("|");
    for (let r of t) {
...
function sg(e) {
    for (let o of e.body.childNodes)
        if (cc(o))
            return;
    let t = tp(e.body.previousSibling);
    if (cc(t))
        return;
    let n = tp(e.head.lastChild);
    if (!cc(n))
        throw new N(-507, !1);
}
function ag(e, t) {
...
function cg() {
    if (ei === void 0 && (ei = null, ye.trustedTypes))
        try {
...
var ti;
function Yl() {
    if (ti === void 0 && (ti = null, ye.trustedTypes))
        try {
...
var dg = rt("area,br,col,hr,img,wbr"), fg = rt("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"), pg = rt("rp,rt"), VT = or(pg, fg), BT = or(fg, rt("address,article,aside,blockquote,caption,center,del,details,dialog,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,main,map,menu,nav,ol,pre,section,summary,table,ul")), $T = or(pg, rt("a,abbr,acronym,audio,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,picture,q,ruby,rp,rt,s,samp,small,source,span,strike,strong,sub,sup,time,track,tt,u,var,video")), Uc = or(dg, BT, $T, VT), Kl = rt("background,cite,href,itemtype,longdesc,poster,src,xlink:href"), UT = rt("abbr,accesskey,align,alt,autoplay,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,controls,coords,datetime,default,dir,download,face,headers,height,hidden,hreflang,hspace,ismap,itemscope,itemprop,kind,label,lang,language,loop,media,muted,nohref,nowrap,open,preload,rel,rev,role,rows,rowspan,rules,scope,scrolling,shape,size,sizes,span,srclang,srcset,start,summary,tabindex,target,title,translate,type,usemap,valign,value,vspace,width"), GT = rt("aria-activedescendant,aria-atomic,aria-autocomplete,aria-busy,aria-checked,aria-colcount,aria-colindex,aria-colspan,aria-controls,aria-current,aria-describedby,aria-details,aria-disabled,aria-dropeffect,aria-errormessage,aria-expanded,aria-flowto,aria-grabbed,aria-haspopup,aria-hidden,aria-invalid,aria-keyshortcuts,aria-label,aria-labelledby,aria-level,aria-live,aria-modal,aria-multiline,aria-multiselectable,aria-orientation,aria-owns,aria-placeholder,aria-posinset,aria-pressed,aria-readonly,aria-relevant,aria-required,aria-roledescription,aria-rowcount,aria-rowindex,aria-rowspan,aria-selected,aria-setsize,aria-sort,aria-valuemax,aria-valuemin,aria-valuenow,aria-valuetext"), hg = or(Kl, UT, GT), WT = rt("script,style,template"), Gc = class {
    ...
    startElement(t) {
        let n = ip(t).toLowerCase();
        if (!Uc.hasOwnProperty(n))
            return this.sanitizedSomething = !0, !WT.hasOwnProperty(n);
...
function Xl(e) {
    let t = rr();
    if (t)
        return rp(t.sanitize(Kt.RESOURCE_URL, e) || "");
    if (qn(e, "ResourceURL"))
        return rp(ot(e));
    throw new N(904, !1);
}
function Ig(e) {
    let t = rr();
    if (t)
        return op(t.sanitize(Kt.SCRIPT, e) || "");
    if (qn(e, "Script"))
        return op(ot(e));
    throw new N(905, !1);
}
...
function hM(e, t, n) {
    let o = 4, r = e.attrs, i = r !== null ? yM(r) : 0, s = !1;
...
function ar(e, t) {
    if (ht(t))
        return;
    let n = t[T];
    n.destroyNode && ps(e, t, n, 3, null, null), SM(t);
}
function lc(e, t) {
    if (ht(t))
        return;
...
function uu(e, t, n, o) {
    let r = lu(e, o, t), i = t[T], s = o.parent || t[re], a = Hg(s, o, t);
    if (r != null)
        if (Array.isArray(n))
...
function Gg(e, t, n, o, r, i) {
    let s = n[Q], c = s[re].projection[o.projection];
    if (Array.isArray(c))
...
function VM(e, t, n) {
    let o = n.directiveStart, r = n.directiveEnd;
    Ee(n) && NM(t, n, e.data[o + n.componentOffset]), e.firstCreatePass || Ci(n, t);
...
function BM(e, t, n) {
    let o = n.directiveStart, r = n.directiveEnd, i = n.index, s = bf();
    try {
        yt(i);
        for (let a = o; a < r; a++) {
...
function hu(e, t) {
    let n = e.directiveRegistry, o = null;
    if (n)
...
function yu(e, t, n, o, r) {
    let i = e.inputs?.[o], s = e.hostDirectiveInputs?.[o], a = !1;
    if (s)
...
function WM(e, t, n, o, r, i) {
    let s = null, a = null, c = null, l = !1, u = e.directiveToIndex.get(o.type);
    if (typeof u == "number" ? s = u : [s, a, c] = u, a !== null && c !== null && e.hostDirectiveInputs?.hasOwnProperty(r)) {
...
var t_ = Le(G({}, ra), { consumerIsAlwaysLive: !0, kind: "template", consumerMarkedDirty: e => {
        let t = Pt(e.lView);
        for (; t && !Kg(t[y]);)
            t = Pt(t);
        t && Hr(t);
    }, consumerOnSignalRead() { this.lView[_e] = this; } });
...
var n_ = 100;
function vu(e, t = 0) {
    let o = e[ze].rendererFactory, r = !1;
    r || o.begin?.();
    try {
        o_(e, t);
    }
...
function Xg(e, t) {
    Pa(t ? Ur.Exhaustive : Ur.OnlyDirtyViews);
    try {
        vu(e);
    }
    finally {
...
function em(e, t, n, o) {
    ...
    i || (Kg(e) ? (l = YM(t), c = ro(l)) : Kd() === null ? (a = !1, l = e_(t), c = ro(l)) : t[_e] && (ia(t[_e]), t[_e] = null));
    try {
...
function Zc(e, t) {
    let o = e[y], r = e[b], i = e[_e], s = !!(t === 0 && r & 16);
    if (s ||= !!(r & 64 && t === 0), s ||= !!(r & 1024), s ||= !!(i?.dirty && Tr(i)), s ||= !1, i && (i.dirty = !1), e[b] &= -9217, s)
...
function Is(e, t) {
    let n = La() ? 64 : 1088;
    for (e[ze].changeDetectionScheduler?.notify(t); e;) {
        e[b] |= n;
        let o = Pt(e);
        if (He(e) && !o)
            return e;
...
var Ct = class {
    ...
    attachToAppRef(t) {
        if (this._attachedToViewContainer)
            throw new N(902, !1);
        this._appRef = t;
        let n = He(this._lView), o = this._lView[pt];
        o !== null && !n && sm(o, this._lView), Vr(this._lView);
    }
};
...
function A_() {
    let e = { stack: [], index: -1 };
    function t(n, o) {
        for (e.lView = o; e.stack.length;)
            e.stack.pop();
        return Du(e, n.value, o), Ri.bind(null, e);
    }
    return t;
}
...
function L_(e) {
    let t = e.match(O_), [n, o, r, i] = t, s = o ? parseInt(o, 10) : r, a = [];
...
function V_(e, t) {
    let n = [], o = null;
    for (o = e; o != null && o !== t; o = o.nextSibling)
        n.push(jh);
    return o == null ? null : n;
}
function up(e, t, n) { let o = Kc(e, t); return o === null ? null : P_(n, o); }
function mm(e, t, n) {
    let o = e.parent, r, i, s;
    for (; o !== null && (Yn(o, t) || n?.has(o.index));)
        o = o.parent;
    o === null || !(o.type & 3) ? (r = s = Ol, i = t[Q][P]) : (r = o.index, i = k(t[r]), s = C(r - I));
    let a = k(t[e.index]);
    if (e.type & 44) {
        let l = Bt(t, e);
        l && (a = l);
...
function ym(e, t) {
    let n = e.createNodeIterator(t, NodeFilter.SHOW_COMMENT, { acceptNode: B_ }), o, r = new Map;
    for (; o = n.nextNode();) {
...
function Tm(e, t, n) {
    if (!n.isI18nHydrationEnabled)
        return null;
    let o = e[y], r = o.data[t];
    if (!r || !r.ast)
        return null;
    let i = o.data[r.parentTNodeIndex];
    if (i && _h(i))
        return null;
    let s = { caseQueue: [], disconnectedNodes: new Set, disjointNodes: new Set };
    return Jc(e, s, n, r.ast), s.caseQueue.length === 0 && s.disconnectedNodes.size === 0 && s.disjointNodes.size === 0 ? null : s;
}
function Jc(e, t, n, o) {
    let r = null;
    for (let i of o) {
...
function W_(e, t, n, o) {
    let r = k(e[o.index]);
    if (!r || pm(r))
        return t.disconnectedNodes.add(o.index - I), null;
    let i = r;
    switch (o.kind) {
        case 0: {
            Ql(n, i);
...
function z_(e, t, n, o) {
    let r = e[ee];
    if (!r || !Ts() || n && (_h(n) || as(r, n.index - I)))
        return;
    let i = e[y], s = i.data[t];
    function a() {
        if (fm(o)) {
            let p = cr(r, i, e, n);
    ...
    let c = a(), l = eg(r) ?? new Set, u = r.i18nNodes ??= new Map, d = r.data[Xi]?.[t - I] ?? [], f = r.dehydratedIcuData ??= new Map;
    dn({ hydrationInfo: r, lView: e, i18nNodes: u, disconnectedNodes: l, caseQueue: d, dehydratedIcuData: f }, { currentNode: c, isConnected: !0 }, s.ast), r.disconnectedNodes = l.size === 0 ? null : l;
}
function dn(e, t, n) {
    if (Array.isArray(n)) {
        let o = t;
...
function K_(e, t, n) {
    for (let o of n.node.cases[n.case]) {
        let r = t.get(o.index - I);
        r && ir(e, r, !1);
    }
}
function Ms(e) {
    let t = e[Ie] ?? [], o = e[W][T], r = [];
    for (let i of t)
        i.data[es] !== void 0 ? r.push(i) : Nm(i, o);
    e[Ie] = r;
}
function J_(e) {
    let { lContainer: t } = e, n = t[Ie];
    if (n === null)
        return;
    let r = t[W][T];
    for (let i of n)
...
function ki(e) {
    Y_(e);
    let t = e[y];
    for (let n = I; n < t.bindingStartIndex; n++)
        if (Y(e[n])) {
            let o = e[n];
            _s(o);
        }
...
function nN(e, t, n) {
    if (t.tView.ssrId === null)
        return null;
    let o = Vo(e, t.tView.ssrId);
    return n[y].firstUpdatePass && o === null && oN(n, t), o;
}
...
function aN(e, t) {
    if (Nr(e) && (e = H(e), !e))
        throw new Error(`Expected forwardRef function, imported from "${ve(t)}", to return a standalone entity or NgModule but got "${ve(e) || e}".`);
    if (nn(e) == null) {
        let n = V(e) || Me(e) || Fe(e);
        if (n != null) {
            if (!n.standalone)
...
var el = class {
    ...
    computeNgModuleScope(t) {
        let n = Or(t), o = { exported: { directives: new Set, pipes: new Set }, compilation: { directives: new Set, pipes: new Set } };
        for (let r of mn(n.imports))
            if (Ht(r)) {
        ...
        for (let r of mn(n.exports))
            if (Ht(r)) {
                ...
                oi(r) ? o.exported.pipes.add(r) : o.exported.directives.add(r);
        return o;
    }
    ...
    computeStandaloneComponentScope(t, n) {
        let o = { compilation: { directives: new Set([t]), pipes: new Set, ngModules: new Set } };
        for (let r of Re(n ?? [])) {
            let i = H(r);
            try {
                aN(i, t);
...
function Ai(e, t, n) {
    let o = n ? e.styles : null, r = n ? e.classes : null, i = 0;
    if (t !== null)
...
function gp(e, t, n) {
    let { attrs: o, inputs: r, hostDirectiveInputs: i } = e;
    if (o === null || !n && r === null || n && i === null || tu(e)) {
...
function Fm(e, t, n, o, r, i) {
    let s = t.consts, a = ie(s, r), c = Jt(t, e, n, o, a);
    if (c.mergedAttrs = _n(c.mergedAttrs, c.attrs), i != null) {
        let l = ie(s, i);
        c.localNames = [];
        for (let u = 0; u < l.length; u += 2)
...
function yN(e, t, n) {
    let o = e[Symbol.iterator](), r = t[Symbol.iterator]();
    for (;;) {
...
function wo(e, t, n) {
    return function o(r) {
        let i = Ee(e) ? de(e.index, t) : t;
        Is(i, 5);
        let s = t[L], a = mp(t, s, n, r), c = o.__ngNextListenerFn__;
        for (; c;)
            a = mp(t, s, c, r) && a, c = c.__ngNextListenerFn__;
        return a;
    };
}
function mp(e, t, n, o) {
...
function Vm(e, t, n, o, r, i, s, a) {
    let c = sn(e), l = !1, u = null;
    if (!o && c && (u = vN(t, n, i, e.index)), u !== null) {
...
function EN(e, t, n, o, r) {
    let i = null, s = null, a = null, c = !1, l = e.directiveToIndex.get(n.type);
    if (typeof l == "number" ? i = l : [i, s, a] = l, s !== null && a !== null && e.hostDirectiveOutputs?.hasOwnProperty(o)) {
...
function bN(e) {
    ...
    if (t === null)
        throw new N(407, !1);
    let n = e.get(xm, null), o = e.get(Qe, null);
    return { rendererFactory: t, sanitizer: n, changeDetectionScheduler: o, ngReflect: !1 };
}
...
function RN(e, t, n, o) {
    let r = e ? ["ng-version", "20.1.0"] : CM(t.selectors[0]), i = null, s = null, a = 0;
    if (n)
        for (let u of n)
            a += u[Dt].requiredVars, u.create && (u.targetIdx = 0, (i ??= []).push(u)), u.update && (u.targetIdx = 0, (s ??= []).push(u));
    if (o)
...
var Pi = class extends Am {
    ...
    setInput(t, n) {
        ...
        if (this.previousInputValues ??= new Map, this.previousInputValues.has(t) && Object.is(this.previousInputValues.get(t), n))
            return;
        let r = this._rootLView, i = yu(o, r[y], r, t, n);
...
var ON = Ss, Gm = class extends ON {
    ...
    get parentInjector() {
        let t = Rl(this._hostTNode, this._hostLView);
        if (dh(t)) {
    ...
    createComponent(t, n, o, r, i, s, a) {
        ...
        let u = c ? t : new Tt(V(t)), d = o || this.parentInjector;
        if (!i && u.ngModule == null) {
            let E = (c ? d : this.parentInjector).get(dt, null);
            E && (i = E);
        }
        let f = V(u.componentType ?? {}), p = Vo(this._lContainer, f?.id ?? null), h = p?.firstChild ?? null, m = u.create(d, r, h, i, s, a);
        return this.insertImpl(m.hostView, l, Gt(this._hostTNode, p)), m;
    }
    ...
    insertImpl(t, n, o) {
        ...
        return Zn(s, r, i, o), t.attachToViewContainerRef(), ha(hc(s), i, t), t;
    }
...
function Qm(e, t, n, o) {
    if (e[ke])
        return;
    let r;
    n.type & 8 ? r = k(o) : r = PN(t, n), e[ke] = r;
}
function LN(e, t, n) {
    if (e[ke] && e[Ie])
        return !0;
    let o = n[ee], r = t.index - I;
    if (!o || Vn(t) || as(o, r))
        return !1;
    let s = Oc(o, r), a = o.data[Bn]?.[r], [c, l] = eN(s, a);
    return e[ke] = c, e[Ie] = l, !0;
}
...
function il(e, t, n, o) {
    let r = e.queries.getByIndex(n), i = r.matches;
    if (i !== null) {
        let s = Ym(e, t, r, n);
...
function Ru(e, t, n) {
    ...
    return o = r[ct], o._dirtyCounter = Qa(0), o._flatValue = void 0, r;
}
...
function GN(e, t) {
    let n = e._lView, o = e._queryIndex;
    if (n === void 0 || o === void 0 || n[b] & 4)
        return t ? void 0 : O;
    let r = bu(n, o), i = ty(n, o);
    return r.reset(i, Th), t ? r.first : r._changesDetected || e._flatValue === void 0 ? e._flatValue = r.toArray() : e._flatValue;
}
function oy(e) {
    let t = [], n = new Map;
    function o(r) {
    ...
    return bn.forEach((r, i) => {
        let s = [];
        r.templateUrl && s.push(o(r.templateUrl).then(l => { r.template = l; }));
        ...
        if (r.styleUrls?.length) {
            ...
            r.styleUrl && s.push(o(r.styleUrl).then(l => { a.push(l), r.styleUrl = void 0; }));
        let c = Promise.all(s).then(() => ZN(i));
        t.push(c);
...
var nw = new Map;
function ow(e) {
    let t = 0, n = typeof e.consts == "function" ? "" : e.consts, o = [e.selectors, e.ngContentSelectors, e.hostVars, e.hostAttrs, n, e.vars, e.decls, e.encapsulation, e.standalone, e.signals, e.exportAs, JSON.stringify(e.inputs), JSON.stringify(e.outputs), Object.getOwnPropertyNames(e.type.prototype), !!e.contentQueries, !!e.viewQuery];
    for (let i of o.join("|"))
...
function Cy(e, t, n, o, r, i, s, a) {
    ...
    a && (e.flags |= a), Ve(e, !1);
    let c = Ty(n, t, e, o);
    Eo() && uu(n, t, c, e), we(c, t);
    let l = rm(c, t, c, e);
    t[o + I] = l, su(t, l), zm(l, e, t);
}
...
function qt(e, t, n, o, r, i, s, a, c, l, u) {
    let d = n + I, f;
    if (t.firstCreatePass) {
        ...
        f = t.data[d];
    return Cy(f, e, t, n, o, r, i, c), l != null && zn(e, f, u), f;
}
...
function hw(e, t, n, o) {
    let r = !cs(t, n);
    Ae(r);
    let i = t[ee]?.data[Ki]?.[o] ?? null;
    if (i !== null && n.tView !== null && n.tView.ssrId === null && (n.tView.ssrId = i), r)
        return My(e, t);
    let s = t[ee], a = cr(s, e, t, n);
    is(s, o, a);
    let c = zl(s, o);
    return Cs(c, a);
}
...
var ks = function (e) { return e[e.CHANGE_DETECTION = 0] = "CHANGE_DETECTION", e[e.AFTER_NEXT_RENDER = 1] = "AFTER_NEXT_RENDER", e; }(ks || {}), Jn = new w(""), by = !1, cl = class extends wl {
    ...
    subscribe(t, n, o) {
        let r = t, i = n || (() => null), s = o;
        if (t && typeof t == "object") {
            let c = t;
            r = c.next?.bind(c), i = c.error?.bind(c), s = c.complete?.bind(c);
        }
        this.__isAsync && (i = this.wrapInTimeout(i), r && (r = this.wrapInTimeout(r)), s && (s = this.wrapInTimeout(s)));
        let a = super.subscribe({ next: r, error: i, complete: s });
        return t instanceof bl && t.add(a), a;
    }
    wrapInTimeout(t) {
        return n => {
...
function Sy(e) {
    ...
    return t = setTimeout(() => { e(), o(); }), typeof requestAnimationFrame == "function" && (n = requestAnimationFrame(() => { e(), o(); })), () => o();
}
...
var $u = "isAngularZone", ji = $u + "_ID", Ew = 0, $ = class e {
    ...
    onError = new Ye(!1);
    constructor(t) {
        let { enableLongStackTrace: n = !1, shouldCoalesceEventChangeDetection: o = !1, shouldCoalesceRunChangeDetection: r = !1, scheduleInRootZone: i = by } = t;
        if (typeof Zone > "u")
            throw new N(908, !1);
    ...
    runTask(t, n, o, r) {
        let i = this._inner, s = i.scheduleEventTask("NgZoneEvent: " + r, t, Dw, Do, Do);
        try {
...
function Cw(e) {
    ...
    function t() { Sy(() => { e.callbackScheduled = !1, ll(e), e.isCheckStableRunning = !0, Uu(e), e.isCheckStableRunning = !1; }); }
    e.scheduleInRootZone ? Zone.root.run(() => { t(); }) : e._outer.run(() => { t(); }), ll(e);
}
function Tw(e) {
    let t = () => { Cw(e); }, n = Ew++;
    e._inner = e._inner.fork({ name: "angular", properties: { [$u]: !0, [ji]: n, [ji + n]: !0 }, onInvokeTask: (o, r, i, s, a, c) => {
            if (Mw(c))
                return o.invokeTask(i, s, a, c);
            try {
...
var As = (() => {
    ...
    class e {
        ...
        execute() {
            ...
            for (let o of this.deferredRegistrations)
                this.sequences.add(o);
            this.deferredRegistrations.size > 0 && this.scheduler.notify(7), this.deferredRegistrations.clear(), n && A(17);
        }
...
function Xn(e, t, n, o, r, i, s) {
    ...
    function u() {
        ...
        let d = pe(e, t), f = d[it];
        if (f !== Wo.Initial && f !== j.Placeholder) {
            l.destroy();
            return;
        }
        let p = kw(e, t, o);
        if (!p || (l.destroy(), ht(p)))
            return;
        let h = Aw(p, n), m = r(h, () => { c.run(() => { e !== p && Ma(p, m), i(); }); }, a);
        e !== p && $r(p, m), dr(s, d, m);
    }
    l = Ay({ read: u }, { injector: a });
}
function Os(e, t) { let n = t.get(Pw), o = () => n.remove(e); return n.add(e), o; }
var xw = () => typeof requestIdleCallback < "u" ? requestIdleCallback : setTimeout, Ow = () => typeof requestIdleCallback < "u" ? cancelIdleCallback : clearTimeout, Pw = (() => {
    class e {
...
var Hy = (() => {
    class e {
        ...
        scheduleTimer(n) {
            let o = () => {
                ...
                let a = -1;
                for (let c = 0; c < this.current.length && this.current[c] <= s; c += 2)
                    a = c + 1;
                if (a >= 0 && ga(this.current, 0, a + 1), this.executingCallbacks = !1, this.deferred.length > 0) {
    ...
    return e;
})(), Fw = new w("DEFER_BLOCK_DEPENDENCY_INTERCEPTOR"), Vy = new w("");
...
function Ke(e, t, n, o = !1) {
    ...
    if (ht(r))
        return;
    let s = pe(r, t), a = s[it], c = s[vw];
    if (!(c !== null && e < c) && bp(a, e) && bp(s[Cn] ?? -1, e)) {
...
function Vw(e, t, n, o, r) {
    let i = Date.now(), s = r[y], a = ne(s, o);
    if (t[Mo] === null || t[Mo] <= i) {
        t[Mo] = null;
...
var Ku = (() => {
    class e {
        ...
        runInitializers() {
            ...
            let o = () => { this.done = !0, this.resolve(); };
            Promise.all(n).then(() => { o(); }).catch(r => { this.reject(r); }), n.length === 0 && o(), this.initialized = !0;
        }
        static ɵfac = function (o) { return new (o || e); };
...
var Oe = (() => {
    class e {
        ...
        bootstrapImpl(n, o, r = Ce.NULL) {
            return this._injector.get($).run(() => {
                A(10);
                let s = n instanceof Ns;
                if (!this._injector.get(Ku).done) {
                    let h = "";
                    throw new N(405, h);
                }
                let c;
                s ? c = n : c = this._injector.get(lr).resolveComponentFactory(n), this.componentTypes.push(c.componentType);
                let l = Zy(c) ? void 0 : this._injector.get(Sn), u = o || c.selector, d = c.create(r, [], u, l), f = d.location.nativeElement, p = d.injector.get(Gy, null);
                return p?.registerApplication(f), d.onDestroy(() => { this.detachView(d.hostView), bo(this.components, d), p?.unregisterApplication(f); }), this._loadComponent(d), A(11, d), d;
            });
        }
        ...
        synchronize() {
            this._rendererFactory === null && !this._injector.destroyed && (this._rendererFactory = this._injector.get(Bo, null, { optional: !0 }));
            let n = 0;
            for (; this.dirtyFlags !== 0 && n++ < Qw;)
...
function Yy(e) {
    ...
    if (eo(t, n), !Xy(0, t))
        return;
    let o = t[z], r = pe(t, n), i = e(() => he(0, t, n), o);
    dr(0, r, i);
}
function Ky(e, t) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return;
    let n = g(), o = n[z], r = M(), i = n[y], s = ne(i, r);
    if (s.loadingState === K.NOT_STARTED) {
...
function Jy(e, t, n) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return;
    let o = t[z], r = pe(t, n), i = r[Rs], s = e(() => st(o, i), o);
    dr(2, r, s);
}
function hr(e, t, n) { Ls(e, t, n); }
function Ls(e, t, n) {
    let o = t[z], r = t[y];
    if (e.loadingState !== K.NOT_STARTED)
        return e.loadingPromise ?? Promise.resolve();
    let i = pe(t, n), s = Rw(r, e);
    e.loadingState = K.IN_PROGRESS, pi(1, i);
    let a = e.dependencyResolverFn, c = o.get(Ka).add();
...
function he(e, t, n) {
    let o = t[y], r = t[n.index];
    if (!Xy(e, t))
        return;
    let i = pe(t, n), s = ne(o, n);
...
function st(e, t, n) {
    return oo(this, null, function* () {
        let o = e.get(nt);
        if (o.hydrating.has(t))
            return;
        let { parentBlockPromise: i, hydrationQueue: s } = _T(t, e);
        if (s.length === 0)
            return;
        i !== null && s.shift(), Kw(o, s), i !== null && (yield i);
        let a = s[0];
        o.has(a) ? yield kp(e, s, n) : o.awaitParentBlock(a, () => oo(null, null, function* () { return yield kp(e, s, n); }));
    });
}
function kp(e, t, n) {
    return oo(this, null, function* () {
        let o = e.get(nt), r = o.hydrating, i = e.get(Lt), s = i.add();
        ...
        let a = t[t.length - 1];
        yield r.get(a)?.promise, i.remove(s), n && n(t), X_(o.get(a), t, o, e.get(Oe));
    });
}
...
function xp(e, t) {
    let n = e[z], o = ne(e[y], t), r = ss(n), i = tb(o.flags);
    if (typeof ngServerMode < "u" && ngServerMode)
        return !r || !i;
    let a = pe(e, t)[Rs] !== null;
    return !(i && a && r);
}
...
function tv(e, t, n, o, r, i, s, a, c, l) {
    let u = g(), d = _(), f = e + I, p = qt(u, d, e, null, 0, 0), h = u[z];
    ...
    let R = [null, Wo.Initial, null, null, null, null, E, v, null, null];
    ww(u, f, R);
    let ae = null;
    E !== null && (ae = h.get(nt), ae.add(E, { lView: u, tNode: p, lContainer: m }));
    let Pe = () => { Ny(R), E !== null && ae?.cleanup([E]); };
    dr(0, R, () => Ma(u, Pe)), $r(u, Pe);
}
function nv(e) {
    let t = g(), n = Ne();
    if (!q(0, t, n))
...
function iv() {
    ...
    if (!q(2, e, t))
        return;
    Nt(_(), t).set(7, null), typeof ngServerMode < "u" && ngServerMode && he(2, e, t);
}
...
function cv() {
    ...
    if (!q(2, e, t))
        return;
    Nt(_(), t).set(0, null), typeof ngServerMode < "u" && ngServerMode ? he(2, e, t) : Jy(Os, e, t);
}
function lv() {
    let e = g(), t = M();
    if (!q(0, e, t))
        return;
    ne(e[y], t).loadingTmplIndex === null && eo(e, t), he(0, e, t);
}
function uv() {
    let e = g(), t = M();
    if (!q(1, e, t))
        return;
    let n = e[y], o = ne(n, t);
    o.loadingState === K.NOT_STARTED && Ls(o, e, t);
}
function dv() {
    let e = g(), t = M();
    if (!q(2, e, t))
        return;
    if (Nt(_(), t).set(1, null), typeof ngServerMode < "u" && ngServerMode)
        he(2, e, t);
    else {
...
function hv(e) {
    ...
    if (!q(2, t, n))
        return;
    Nt(_(), n).set(5, { delay: e }), typeof ngServerMode < "u" && ngServerMode ? he(2, t, n) : Jy(Ps(e), t, n);
}
...
function mv(e, t) {
    ...
    if (!q(1, n, o))
        return;
    let r = n[y], i = ne(r, o);
    i.loadingState === K.NOT_STARTED && Xn(n, o, e, t, Bh, () => hr(i, n, o), 1);
}
function yv() {
    let e = g(), t = M();
    if (!q(2, e, t))
        return;
    Nt(_(), t).set(4, null), typeof ngServerMode < "u" && ngServerMode && he(2, e, t);
}
...
function Iv(e, t) {
    ...
    if (!q(1, n, o))
        return;
    let r = n[y], i = ne(r, o);
    i.loadingState === K.NOT_STARTED && Xn(n, o, e, t, Vh, () => hr(i, n, o), 1);
}
function Ev() {
    let e = g(), t = M();
    if (!q(2, e, t))
        return;
    Nt(_(), t).set(3, null), typeof ngServerMode < "u" && ngServerMode && he(2, e, t);
}
...
function Cv(e, t) {
    ...
    if (!q(1, n, o))
        return;
    let r = n[y], i = ne(r, o);
    i.loadingState === K.NOT_STARTED && Xn(n, o, e, t, qu, () => hr(i, n, o), 1);
}
function Tv() {
    let e = g(), t = M();
    if (!q(2, e, t))
        return;
    Nt(_(), t).set(2, null), typeof ngServerMode < "u" && ngServerMode && he(2, e, t);
}
function ed(e, t, n, o) {
    let r = g(), i = fe();
    if (U(r, i, t)) {
...
var pl = class {
    ...
    updateValue(t, n) { }
    swap(t, n) {
        let o = Math.min(t, n), r = Math.max(t, n), i = this.detach(r);
        if (r - o > 1) {
            let s = this.detach(o);
...
function sb(e, t, n) {
    let o, r, i = 0, s = e.length - 1, a = void 0;
    if (Array.isArray(t)) {
        let c = t.length - 1;
        for (; i <= s && i <= c;) {
...
function Nv(e, t) {
    se("NgControlFlow");
    let n = g(), o = fe(), r = n[o] !== x ? n[o] : -1, i = r !== -1 ? Vi(n, I + r) : void 0, s = 0;
    if (U(n, o, e)) {
        let a = S(null);
        try {
...
function js(e, t, n, o) {
    let r = g(), i = r[y], s = e + I, a = i.firstCreatePass ? _u(s, r, 2, t, hu, Gr(), n, o) : i.data[s];
    if (gs(a, r, e, t, rd), sn(a)) {
        let c = r[y];
        hs(c, r, a), Zl(c, a, r);
    }
...
function lb(e, t, n, o, r) {
    let i = !cs(t, n);
    if (Ae(i), i)
        return us(t[T], o, qa());
    let s = t[ee], a = cr(s, e, t, n);
    return Xh(s, r) && is(s, r, a.nextSibling), s && (Al(n) || Mh(a)) && Ee(n) && (Mf(n), kg(a)), a;
}
function kv() { rd = lb; }
function $s(e, t, n) {
    let o = g(), r = o[y], i = e + I, s = r.firstCreatePass ? _u(i, o, 8, "ng-container", hu, Gr(), t, n) : r.data[i];
    if (gs(s, o, e, "ng-container", cd), sn(s)) {
        let a = o[y];
        hs(a, o, s), Zl(a, s, o);
    }
...
function ub(e, t, n, o, r) {
    ...
    if (Ae(s), s)
        return ou(t[T], "");
    let a = t[ee], c = cr(a, e, t, n), l = Jh(a, r);
    return is(a, r, c), i = Cs(l, c), i;
}
function Av() { cd = ub; }
...
function _b(e, t, n, o) {
    let r = Nb(t, o);
    if (Ds(t, n) !== r && (Uv(e, t, n), n[t.currentCaseLViewIndex] = r === null ? null : ~r, r !== null)) {
        let s = n[t.anchorIdx];
...
function jp(e) {
    let t, n = "", o = 0, r = !1, i;
    for (; (t = Sb.exec(e)) !== null;)
        r ? t[0] === `${ko}/*${i}${ko}` && (o = t.index, r = !1) : (n += e.substring(o, t.index + t[0].length), i = t[1], r = !0);
...
function zv(e, t, n, o, r, i, s) {
    let a = 0, c = { type: i.type, currentCaseLViewIndex: sr(t, n, 1, null), anchorIdx: s, cases: [], create: [], remove: [], update: [] };
    Bb(o, i, s), N_(t, s, c);
    let l = i.values, u = [];
    for (let d = 0; d < l.length; d++) {
        let f = l[d], p = [];
...
function jb(e) {
    let t = [], n = [], o = 1, r = 0;
    e = e.replace(Gv, function (s, a, c) { return c === "select" ? o = 0 : o = 1, r = parseInt(a.slice(1), 10), ""; });
    let i = El(e);
...
function Qv(e, t, n, o, r, i, s, a, c, l, u, d) {
    let f = 0, p = c.firstChild;
    for (; p;) {
        let h = sr(t, o, 1, null);
        switch (p.nodeType) {
            case Node.ELEMENT_NODE:
...
function Kb(e, t = {}) {
    ...
    if (Gb.test(e)) {
        let o = {}, r = [Vp];
        n = n.replace(Wb, (i, s, a) => {
            let c = s || a, l = o[c] || [];
            if (l.length || (c.split("|").forEach(m => { let v = m.match(Yb), E = v ? parseInt(v[1], 10) : Vp, R = Zb.test(m); l.push([E, R, m]); }), o[c] = l), !l.length)
                throw new Error(`i18n postprocess: unmatched placeholder - ${c}`);
            let u = r[r.length - 1], d = 0;
    ...
    return Object.keys(t).length && (n = n.replace(qb, (o, r, i, s, a, c) => t.hasOwnProperty(i) ? `${r}${t[i]}${c}` : o), n = n.replace(zb, (o, r) => t.hasOwnProperty(r) ? t[r] : o), n = n.replace(Qb, (o, r) => {
...
function fd(e, t, n = -1) {
    let o = _(), r = g(), i = I + e, s = ie(o.consts, t), a = an();
    if (o.firstCreatePass && xb(o, a === null ? 0 : a.index, r, i, s, n), o.type === 2) {
        let f = r[Q];
        f[b] |= 32;
    }
    else
        r[b] |= 32;
    let c = o.data[i], l = a === r[re] ? null : a, u = jg(o, l, r), d = a && a.type & 8 ? r[a.index] : null;
    $_(r, i, a, n), Mb(r, c.create, u, d), Ha(!0);
}
function pd() { Ha(!1); }
...
function vd(e, t, n, o, r, i, s) {
    let a = !0, c = null;
    if ((o.type & 3 || s) && (c ??= wo(o, t, i), Vm(o, e, t, s, n, r, i, c) && (a = !1)), a) {
...
function rI(e) {
    ...
    Io(o + 1);
    let r = Su(n, o);
    if (e.dirty && gf(t) === ((r.metadata.flags & 2) === 2)) {
        if (r.matches === null)
            e.reset([]);
        else {
            let i = ty(t, o);
...
function oS(e, t, n, o, r, i) {
    let s = i ? t.classBindings : t.styleBindings, a = zt(s), c = On(s);
    e[o] = n;
    let l = !1, u;
    if (Array.isArray(n)) {
        let d = n;
    ...
    if (r) {
        ...
        e[o + 1] = ii(c, 0), a === 0 ? a = o : e[c + 1] = Ic(e[c + 1], o), c = o;
    l && (e[o + 1] = Dl(e[o + 1])), Bp(e, u, o, !0), Bp(e, u, o, !1), rS(t, u, e, o, i), s = ii(a, c), i ? t.classBindings = s : t.styleBindings = s;
}
function rS(e, t, n, o, r) { let i = r ? e.residualClasses : e.residualStyles; i != null && typeof t == "string" && xr(i, t) >= 0 && (n[o + 1] = Cl(n[o + 1])); }
function Bp(e, t, n, o) {
    let r = e[n + 1], i = t === null, s = o ? zt(r) : On(r), a = !1;
    for (; s !== 0 && (a === !1 || i);) {
        let c = e[s], l = e[s + 1];
...
function uS(e, t, n) {
    let o;
    for (; t < n && ((o = e.charCodeAt(t)) === 45 || o === 95 || (o & -33) >= 65 && (o & -33) <= 90 || o >= 48 && o <= 57);)
        t++;
    return t;
}
function $p(e, t, n, o) { return t = Pn(e, t, n), t < n && t++, t; }
function dS(e, t, n) {
    let o = -1, r = -1, i = -1, s = t, a = s;
    for (; s < n;) {
...
function fS(e, t) {
    for (let n = cS(t); n >= 0; n = fI(t, n))
        EI(e, uI(t), sS(t));
}
function gI(e) { yI(IS, pS, e, !0); }
function pS(e, t) {
    for (let n = aS(t); n >= 0; n = dI(t, n))
        co(e, uI(t), !0);
}
function mI(e, t, n, o) {
    let r = g(), i = _(), s = $e(2);
    if (i.firstUpdatePass && II(i, e, s, o), t !== x && U(r, s, t)) {
        let a = i.data[te()];
...
function yI(e, t, n, o) {
    let r = _(), i = $e(2);
    r.firstUpdatePass && II(r, null, i, o);
    let s = g();
    if (n !== x && U(s, i, n)) {
        let a = r.data[te()];
        if (CI(a, o) && !vI(r, i)) {
...
function hS(e, t, n, o) {
    let r = Wr(e), i = o ? t.residualClasses : t.residualStyles;
    if (r === null)
...
function Ec(e, t, n, o, r) {
    ...
    for (a === -1 ? a = n.directiveStart : a++; a < s && (i = t[a], o = Qo(o, i.hostAttrs, r), i !== e);)
        a++;
...
function vS(e, t, n) {
    ...
    if (Array.isArray(r))
        ...
        typeof r == "string" && t(o, r);
    return o;
}
function EI(e, t, n) { co(e, t, ot(n)); }
function IS(e, t, n) { let o = String(t); o !== "" && !o.includes(" ") && co(e, o, n); }
function ES(e, t, n, o, r, i, s, a) {
    r === x && (r = O);
    let c = 0, l = 0, u = 0 < r.length ? r[0] : null, d = 0 < i.length ? i[0] : null;
    for (; u !== null || d !== null;) {
...
function DI(e, t, n, o, r, i, s, a) {
    if (!(t.type & 3))
        return;
    let c = e.data, l = c[a + 1], u = nS(l) ? Gp(c, t, n, r, On(l), s) : void 0;
    if (!$i(u)) {
...
function HI(e, t) {
    let n = _(), o = g(), r = o[T], i = "data-ng-source-location";
...
function si(e) {
    if (typeof e == "function")
        return e;
    let t = Re(e);
    return t.some(Nr) ? () => t.map(H).map(Wp) : t.map(Wp);
}
...
function gE(e, t, n, o, r, i) {
    ...
    for (let c = 0; c < r.length; c++)
        U(e, s++, r[c]) && (a = !0);
    return a ? We(e, s, o.apply(i, r)) : yr(e, s);
}
function mE(e, t) {
    let n = _(), o, r = e + I;
    n.firstCreatePass ? (o = wS(t, n.pipeRegistry), n.data[r] = o, o.onDestroy && (n.destroyHooks ??= []).push(r, o.onDestroy)) : o = n.data[r];
    let i = o.factory || (o.factory = kr(o.type, !0)), s, a = Rt(Kn);
    try {
        let c = Di(!1), l = i();
...
function NE(e, t, n, o, r = null, i = null) {
    let s = V(e);
    t.apply(null, [e, n, ...o]);
    let { newDef: a, oldDef: c } = bS(s, V(e));
    if (e[en] = a, c.tView) {
        let l = HC().values();
        for (let u of l)
...
function RS(e, t, n, o, r) {
    let i = r[L], s = r[P], a = r[W], c = r[re], l = r[z].get($, null), u = () => {
        if (o.encapsulation === Xe.ShadowDom) {
            let h = s.cloneNode(!1);
            s.replaceWith(h), s = h;
        }
        let d = xg(n), f = ds(a, d, i, iu(n), s, c, null, null, null, null, null);
        kS(a, r, f, c.index), ar(r[y], r);
        let p = r[ze].rendererFactory;
        SS(p, o), f[T] = p.createRenderer(s, n), Lg(r[y], r), AS(c), ys(d, f, i), em(d, f, d.template, i);
    };
    l === null ? qp(e, t, u) : l.run(() => qp(e, t, u));
}
function qp(e, t, n) {
    try {
        n();
...
function kS(e, t, n, o) {
    for (let r = I; r < e[y].bindingStartIndex; r++) {
        let i = e[r];
        if ((Z(i) || Y(i)) && i[oe] === t) {
            i[oe] = n;
            break;
...
function kE(e, t, n = !1) {
    let o = Re(t.declarations || O), r = null;
    Object.defineProperty(e, da, { configurable: !0, get: () => (r === null && (r = J({ usage: 0, kind: "NgModule", type: e }).compileNgModule(le, `ng:///${e.name}/\u0275mod.js`, { type: e, bootstrap: Re(t.bootstrap || O).map(H), declarations: o.map(H), imports: Re(t.imports || O).map(H).map(zp), exports: Re(t.exports || O).map(H).map(zp), schemas: t.schemas ? Re(t.schemas) : null, id: t.id || null }), r.schemas || (r.schemas = [])), r) });
    let i = null;
    Object.defineProperty(e, lt, { get: () => {
            if (i === null) {
    ...
    let s = null;
    Object.defineProperty(e, ua, { get: () => {
            if (s === null) {
...
function VS(e, t) {
    let n = Re(t.declarations || O), o = Od(e);
    n.forEach(r => {
        if (r = H(r), r.hasOwnProperty(en)) {
            let s = V(r);
            xd(s, o);
        }
        else
...
function Pd(e, t) {
    let n = null;
    OE(e, t || {}), Object.defineProperty(e, br, { get: () => {
            if (n === null) {
                let o = xE(e, t || {});
...
function LE(e) {
    let t = Object.prototype, n = Object.getPrototypeOf(e.prototype).constructor;
    for (; n && n !== t;)
...
function QS(e) {
    let t = kl();
    if (zS.some(o => t.hasLifecycleHook(e, o)))
        return !0;
...
function BE(e, t) {
    ...
    Object.defineProperty(e, lt, { get: () => {
            ...
            return o;
        }, configurable: !1 }), Object.defineProperty(e, Sr, { get: () => {
            if (n === null) {
                let r = Zp(e, t);
...
var iR = (() => {
    class e {
        ...
        initialize() {
            ...
            this.initialized = !0;
            let n = null;
            !this.zone.isStable && !this.zone.hasPendingMacrotasks && !this.zone.hasPendingMicrotasks && (n = this.pendingTasks.add()), this.zone.runOutsideAngular(() => { this.subscription.add(this.zone.onStable.subscribe(() => { $.assertNotInAngularZone(), queueMicrotask(() => { n !== null && !this.zone.hasPendingMacrotasks && !this.zone.hasPendingMicrotasks && (this.pendingTasks.remove(n), n = null); }); })); }), this.subscription.add(this.zone.onUnstable.subscribe(() => { $.assertInAngularZone(), n ??= this.pendingTasks.add(); }));
        }
    ...
    class e {
        ...
        notify(n) {
            ...
            if (this.appRef.tracingSnapshot = this.tracing?.snapshot(this.appRef.tracingSnapshot) ?? null, !this.shouldScheduleTick(o))
                return;
            let r = this.useMicrotaskScheduler ? Tp : Sy;
...
var Zo = class {
    ...
    get properties() {
        let t = me(this.nativeNode), n = t ? t.lView : null;
        if (n === null)
            return {};
        let o = n[y].data, r = o[t.nodeIndex], i = {};
        return fR(this.nativeElement, i), hR(i, r, n, o), i;
    }
    get attributes() {
        let t = {}, n = this.nativeElement;
        if (!n)
            return t;
        let o = me(n), r = o ? o.lView : null;
        if (r === null)
            return {};
        let i = r[y].data[o.nodeIndex].attrs, s = [];
        if (i) {
            let a = 0;
            for (; a < i.length;) {
                let c = i[a];
    ...
    get childNodes() {
        let t = this.nativeNode.childNodes, n = [];
        for (let o = 0; o < t.length; o++) {
            let r = t[o];
            n.push(Ln(r));
        }
    ...
    triggerEventHandler(t, n) {
        let o = this.nativeNode, r = [];
        this.listeners.forEach(i => {
            if (i.name === t) {
                let s = i.callback;
                s.call(o, n), r.push(s);
            }
        }), typeof o.eventListeners == "function" && o.eventListeners(t).forEach(i => {
...
function Yp(e, t, n, o) {
    let r = me(e.nativeNode), i = r ? r.lView : null;
    if (i !== null) {
...
function gD(e) {
    let t = Ir(e) ? e.r3Injector : e.moduleRef.injector, n = t.get($);
    return n.run(() => {
        Ir(e) ? e.r3Injector.resolveInjectorInitializers() : e.moduleRef.resolveInjectorInitializers();
        let o = t.get(vt), r;
        if (n.runOutsideAngular(() => { r = n.onError.subscribe({ next: o }); }), Ir(e)) {
        ...
        return TR(o, n, () => {
            ...
            return i.runInitializers(), i.donePromise.then(() => {
                let s = t.get(Ld, mr);
                if (jv(s || mr), !t.get(DR, !0))
                    return Ir(e) ? t.get(Oe) : (e.allPlatformModules.push(e.moduleRef), e.moduleRef);
                if (Ir(e)) {
                    let c = t.get(Oe);
...
var yD = (() => {
    class e {
        ...
        destroy() {
            ...
            let n = this._injector.get(Ys, null);
...
function _R(e, t, n = []) {
    let o = `Platform: ${t}`, r = new w(o);
    return (i = []) => {
        let s = Zd();
        if (!s || s.injector.get(vD, !1)) {
...
var Bd = class extends bR {
    ...
    check(t) {
        ...
        if (Array.isArray(t)) {
            ...
            r = 0, jm(t, a => { s = this._trackByFn(r, a), n === null || !Object.is(n.trackById, s) ? (n = this._mismatch(n, a, s, r), o = !0) : (o && (n = this._verifyReinsertion(n, a, s, r)), Object.is(n.item, a) || this._addIdentityChange(n, a)), n = n._next, r++; }), this.length = r;
...
var TD = (() => {
    ...
    return e;
})(), AR = [new Xs], xR = [new Ks], rx = new CD(xR), ix = new TD(AR), sx = _R(null, "core", []), ax = (() => {
    class e {
        constructor(n) { }
...
function OR() {
    let e = [{ provide: ns, useFactory: () => {
                let t = !0;
                if (typeof ngServerMode > "u" || !ngServerMode) {
                    let n = D(_t);
                    t = !!window._ejsas?.[n];
                }
                return t && se("NgEventReplay"), t;
            } }];
    return (typeof ngServerMode > "u" || !ngServerMode) && e.push({ provide: ut, useValue: () => {
            let t = D(Oe), { injector: n } = t;
            if (!Qs.has(t)) {
                let o = D(nr);
                if (iD(n)) {
                    Wh();
            ...
            return () => {
                ...
                Qs.add(t);
                let o = n.get(_t);
                t.onDestroy(() => { Qs.delete(t), typeof ngServerMode < "u" && !ngServerMode && ec(o); }), t.whenStable().then(() => {
                    if (t.destroyed)
                        return;
                    let r = n.get(Gl);
                    PR(r, n);
                    let i = n.get(nr);
                    i.get(rD)?.forEach(Ul), i.delete(rD);
                    let s = r.instance;
                    ss(n) ? t.onDestroy(() => s.cleanUp()) : s.cleanUp();
                });
            };
        }, multi: !0 }), e;
}
var PR = (e, t) => {
    let n = t.get(_t), o = window._ejsas[n], r = e.instance = new Hf(new Pf(o.c));
    for (let a of o.et)
        r.addEvent(a);
    for (let a of o.etc)
        r.addEvent(a);
    let i = Vf(n);
    r.replayEarlyEventInfos(i), ec(n);
    let s = new Ff(a => { FR(t, a, a.currentTarget); });
    jf(r, s);
};
function LR(e, t, n) {
    let o = new Map, r = t[kt], i = e.cleanup;
    if (!i || !r)
        return o;
    for (let s = 0; s < i.length;) {
        let a = i[s++], c = i[s++];
...
function HR(e) {
    let t = [...Zs], n = new Set(e);
    Zs = [];
    for (let { event: o, currentTarget: r } of t) {
...
function wD(e, t, n) {
    let o = go(e[P]), r = ND(o, t);
    if (r === null)
        return;
    let i = k(o[P]), s = e[W], a = ea(i, s, null, t), c = o[T], l = `${r}|${a}`;
    c.setAttribute(i, En, l);
}
function lx(e, t) {
    let n = e.injector, o = Dm(n), r = ss(n), i = new zd, s = new Map, a = e._views, c = n.get(ns, Hl), l = { regular: new Set, capture: new Set }, u = new Map, d = e.injector.get(_t);
    for (let h of a) {
        let m = ql(h);
        if (m !== null) {
    ...
    let f = i.getAll(), p = n.get(Zt);
    if (p.set(os, f), u.size > 0) {
        let h = {};
...
function UR(e) {
    let t = new Set([0, 1, 2, 5]), n = [];
    for (let [o, r] of e)
        t.has(o) && (r === null ? n.push(o) : n.push({ trigger: o, delay: r.delay }));
    return n;
}
...
function bD(e, t = null, n) {
    let o = {}, r = e[y], i = Cm(r, n), s = n.shouldReplayEvents ? LR(r, e, n.eventTypesToReplay) : null;
    for (let a = I; a < r.bindingStartIndex; a++) {
...
function QR(e, t, n, o) {
    let r = tg(e.hydrateTriggers);
    for (let i of r)
        o.eventTypesToReplay.regular.add(i);
    if (r.length > 0) {
...
var ux = "ngcm";
function dx() {
    let e = [{ provide: Yt, useFactory: () => { let t = !0; return (typeof ngServerMode > "u" || !ngServerMode) && (t = !!D(Zt, { optional: !0 })?.get(os, null)), t && se("NgHydration"), t; } }, { provide: ut, useValue: () => { Cu(!1), !(typeof ngServerMode < "u" && ngServerMode) && D(Yt) && (sg(Mt()), ZR()); }, multi: !0 }];
    return (typeof ngServerMode > "u" || !ngServerMode) && e.push({ provide: Fl, useFactory: () => D(Yt) }, { provide: pr, useFactory: () => {
            if (D(Yt)) {
                let t = D(Oe);
...
function mx(e) {
    if (!na)
        return;
    let { startLabel: t } = SD(e);
    performance.mark(t);
}
function yx(e) {
    if (!na)
        return;
    let { startLabel: t, labelName: n, endLabel: o } = SD(e);
    performance.mark(o), performance.measure(n, t, o), performance.clearMarks(t), performance.clearMarks(o);
}
function SD(e) { let t = `${XR}:${e}`; return { labelName: t, startLabel: `start:${t}`, endLabel: `end:${t}` }; }
var uD = !1;
function vx() {
    if (!uD && (typeof performance > "u" || !performance.mark || !performance.measure)) {
...
var Hd = Symbol("NOT_SET"), RD = new Set, tk = Le(G({}, aa), { consumerIsAlwaysLive: !0, consumerAllowSignalWrites: !0, value: Hd, cleanup: null, consumerMarkedDirty() {
        ...
        if (this.sequence.lastPhase = this.phase, !this.dirty)
            return this.signal;
        if (this.dirty = !1, this.value !== Hd && !Tr(this))
            return this.signal;
        try {
        ...
        return (this.value === Hd || !this.equal(this.value, o)) && (this.value = o, this.version++), this.signal;
    } }), Qd = class extends qo {
    scheduler;
    lastPhase = null;
    nodes = [void 0, void 0, void 0, void 0];
    constructor(t, n, o, r, i, s = null) {
        super(t, [void 0, void 0, void 0, void 0], o, !1, i, s), this.scheduler = r;
        for (let a of Gu) {
            let c = n[a];
            if (c === void 0)
                continue;
...
function Rx(e, t) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return xs;
    let n = t?.injector ?? D(Ce), o = n.get(Qe), r = n.get(As), i = n.get(Jn, null, { optional: !0 });
    r.impl ??= n.get(Wu);
    let s = e;
    typeof s == "function" && (s = { mixedReadWrite: e });
    let a = n.get(Kr, null, { optional: !0 }), c = new Qd(r.impl, [s.earlyRead, s.write, s.mixedReadWrite, s.read], a?.view, o, n.get(cn), i?.snapshot(null));
...
function Ax(e) {
    ...
    if (!t)
        return null;
    let n = new Tt(t);
    return { get selector() { return n.selector; }, get type() { return n.componentType; }, get inputs() { return n.inputs; }, get outputs() { return n.outputs; }, get ngContentSelectors() { return n.ngContentSelectors; }, get isStandalone() { return t.standalone; }, get isSignal() { return t.signals; } };
}
