...
function j(t, n) {
    let e = t ? Ut(t) : void 0, r = n ? Ut(n) : void 0;
...
function Er(t, n, e) {
    if (!te(t.segments, n.segments) || !Qe(t.segments, n.segments, e) || t.numberOfChildren !== n.numberOfChildren)
        return !1;
...
var xt = class {
    ...
    parseChildren() {
        ...
        let r = {};
        return this.peekStartsWith("(") && (r = this.parseParens(!1)), (n.length > 0 || Object.keys(e).length > 0) && (r[f] = new g(n, e)), r;
    }
    parseSegment() {
        let n = Tt(this.remaining);
        if (n === "" && this.peekStartsWith(";"))
            throw new I(4009, !1);
        return this.capture(n), new Q(Ye(n), this.parseMatrixParams());
    }
    parseMatrixParams() {
        let n = {};
...
function Lr(t, n, e, r) {
    ...
    let o = fi(n);
    if (o.toRoot())
        return Et(i, i, new g([], {}), e, r);
    let s = pi(o, i, t), a = s.processChildren ? Ae(s.segmentGroup, s.index, o.commands) : kr(s.segmentGroup, s.index, o.commands);
    return Et(i, s.segmentGroup, a, e, r);
}
...
var Je = class {
    ...
    commands;
    constructor(n, e, r) {
        if (this.isAbsolute = n, this.numberOfDoubleDots = e, this.commands = r, n && r.length > 0 && Xe(r[0]))
            throw new I(4003, !1);
        let i = r.find(Me);
        if (i && i !== Ar(r))
            throw new I(4004, !1);
...
function fi(t) {
    ...
    let n = 0, e = !1, r = t.reduce((i, o, s) => {
        ...
        return typeof o != "string" ? [...i, o] : s === 0 ? (o.split("/").forEach((a, u) => { u == 0 && a === "." || (u == 0 && a === "" ? e = !0 : a === ".." ? n++ : a != "" && i.push(a)); }), i) : [...i, o];
    }, []);
    return new Je(e, n, r);
}
var he = class {
...
function pi(t, n, e) {
    if (t.isAbsolute)
        return new he(n, !0, 0);
    if (!e)
        return new he(n, !1, NaN);
    if (e.parent === null)
        return new he(e, !0, 0);
    let r = Xe(t.commands[0]) ? 0 : 1, i = e.segments.length - 1 + r;
    return gi(e, i, t.numberOfDoubleDots);
}
function gi(t, n, e) {
    let r = t, i = n, o = e;
    for (; o > i;) {
...
function kr(t, n, e) {
    if (t ??= new g([], {}), t.segments.length === 0 && t.hasChildren())
        return Ae(t, n, e);
    let r = mi(t, n, e), i = e.slice(r.commandIndex);
...
function mi(t, n, e) {
    let r = 0, i = n, o = { match: !1, pathIndex: 0, commandIndex: 0 };
...
function _t(t, n, e) {
    let r = t.segments.slice(0, n), i = 0;
    for (; i < e.length;) {
        let o = e[i];
        if (Me(o)) {
            let u = Ri(o.outlets);
...
function wi(t) { let n = {}, e = {}, r = {}, i = "", o = new re([], n, r, i, e, f, t, null, {}); return new Pe("", new T(o, [])); }
var q = class {
    urlSubject;
    paramsSubject;
    queryParamsSubject;
...
var qr = new ie(""), Kt = (() => {
    class t {
        ...
        activateWith(e, r) {
            ...
            let i = this.location, s = e.snapshot.component, a = this.parentContexts.getOrCreateContext(this.name).children, u = new $t(e, a, i.injector, this.routerOutletData);
            this.activated = i.createComponent(s, { index: i.length, injector: u, environmentInjector: r }), this.changeDetector.markForCheck(), this.inputBinder?.bindActivatedRouteToOutletComponent(this), this.activateEvents.emit(this.activated.instance);
        }
        static ɵfac = function (r) { return new (r || t); };
    ...
    class t {
        ...
        subscribeToRouteData(e) {
            let { activatedRoute: r } = e, i = Wt([r.queryParams, r.params, r.data]).pipe(U(([o, s, a], u) => (a = h(h(h({}, o), s), a), u === 0 ? d(a) : Promise.resolve(a)))).subscribe(o => {
                if (!e.isActivated || !e.activatedComponentRef || e.activatedRoute !== r || r.component === null) {
                    this.unsubscribeFromRouteData(e);
                    return;
                }
                let s = Nn(r.component);
                if (!s) {
                    this.unsubscribeFromRouteData(e);
                    return;
                }
...
var Ei = (t, n, e, r) => R(i => (new zt(n, i.targetRouterState, i.currentRouterState, e, r).activate(t), i)), zt = class {
    ...
    deactivateRoutes(n, e, r) {
        let i = n.value, o = e ? e.value : null;
        if (i === o) {
            if (i.component) {
    ...
    detachAndStoreRouteSubtree(n, e) {
        let r = e.getContext(n.value.outlet), i = r && n.value.component ? r.children : e, o = ce(n);
...
function Di(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) {
    let o = t.value, s = n ? n.value : null, a = e ? e.getContext(t.value.outlet) : null;
    if (s && o.routeConfig === s.routeConfig) {
        ...
        s && Te(n, a, i), i.canActivateChecks.push(new pt(r)), o.component ? be(t, null, a ? a.children : null, r, i) : be(t, null, e, r, i);
    return i;
}
function Ni(t, n, e) {
...
function ye() {
    return U(t => Wt(t.map(n => n.pipe(Oe(1), Wn(Ge)))).pipe(R(n => {
        for (let e of n)
            if (e !== !0) {
                if (e === Ge)
                    return Ge;
...
function Hi(t, n, e) {
    ...
    if (!r || r.length === 0)
        return d(!0);
    let i = r.map(o => Gt(() => { let s = Se(n) ?? e, a = Ce(o, s), u = xi(a) ? a.canActivate(n, t) : _(s, () => a(n, t)); return H(u).pipe(oe()); }));
    return d(i).pipe(ye());
}
...
function Wi(t, n, e, r, i) {
    ...
    if (!o || o.length === 0)
        return d(!0);
    let s = o.map(a => { let u = Se(n) ?? i, c = Ce(a, u), m = Li(c) ? c.canDeactivate(t, n, e, r) : _(u, () => c(t, n, e, r)); return H(m).pipe(oe()); });
    return d(s).pipe(ye());
}
function Gi(t, n, e, r) {
    let i = n.canLoad;
    if (i === void 0 || i.length === 0)
        return d(!0);
    let o = i.map(s => { let a = Ce(s, t), u = Pi(a) ? a.canLoad(n, e) : _(t, () => a(n, e)); return H(u); });
    return d(o).pipe(ye(), Gr(r));
}
function Gr(t) {
    return Bn(C(n => {
        if (typeof n != "boolean")
...
function Qi(t, n, e, r) {
    ...
    if (!i || i.length === 0)
        return d(!0);
    let o = i.map(s => { let a = Ce(s, t), u = ji(a) ? a.canMatch(n, e) : _(t, () => a(n, e)); return H(u); });
    return d(o).pipe(ye(), Gr(r));
}
var _e = class {
    segmentGroup;
...
function Zi(t, n, e) {
    if (typeof t == "string")
        return d(t);
    let r = t, { queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, params: c, data: m, title: S } = n;
    return H(_(e, () => r({ params: c, data: m, queryParams: i, fragment: o, routeConfig: s, url: a, outlet: u, title: S })));
}
...
function Qr(t, n, e) {
    if (n.path === "**")
        return Ji(e);
    if (n.path === "")
        return n.pathMatch === "full" && (t.hasChildren() || e.length > 0) ? h({}, qt) : { matched: !0, consumedSegments: [], remainingSegments: e, parameters: {}, positionalParamSegments: {} };
    let i = (n.matcher || br)(e, t, n);
    if (!i)
        return h({}, qt);
    let o = {};
    Object.entries(i.posParams ?? {}).forEach(([a, u]) => { o[a] = u.path; });
    let s = i.consumed.length > 0 ? h(h({}, o), i.consumed[i.consumed.length - 1].parameters) : o;
    return { matched: !0, consumedSegments: i.consumed, remainingSegments: e.slice(i.consumed.length), parameters: s, positionalParamSegments: i.posParams ?? {} };
}
...
var so = 31, Ht = class {
    ...
    match(n) {
        let e = new re([], Object.freeze({}), Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, Object.freeze({}), f, this.rootComponentType, null, {});
        return this.processSegmentGroup(this.injector, this.config, n, f, e).pipe(R(r => ({ children: r, rootSnapshot: e })), Ie(r => {
            if (r instanceof Le)
                return this.urlTree = r.urlTree, this.match(r.urlTree.root);
            throw r instanceof _e ? this.noMatchError(r) : r;
        }));
    }
    ...
    processChildren(n, e, r, i) {
        ...
        return $(o).pipe(Ze(s => { let a = r.children[s], u = Ci(e, s); return this.processSegmentGroup(n, u, a, s, i); }), Gn((s, a) => (s.push(...a), s)), Sr(null), Qn(), x(s => {
            if (s === null)
                return ue(r);
            let a = Kr(s);
            return ao(a), d(a);
    ...
    processSegment(n, e, r, i, o, s, a) {
        return $(e).pipe(Ze(u => this.processSegmentAgainstRoute(u._injector ?? n, e, u, r, i, o, s, a).pipe(Ie(c => {
            if (c instanceof _e)
                return d(null);
            throw c;
        }))), oe(u => !!u), Ie(u => {
            if (Wr(u))
                return io(r, i, o) ? d(new Bt) : ue(r);
            throw u;
        }));
    }
    ...
    expandSegmentAgainstRouteUsingRedirect(n, e, r, i, o, s, a) {
        let { matched: u, parameters: c, consumedSegments: m, positionalParamSegments: S, remainingSegments: D } = Qr(e, i, o);
        if (!u)
            return ue(e);
        typeof i.redirectTo == "string" && i.redirectTo[0] === "/" && (this.absoluteRedirectCount++, this.absoluteRedirectCount > so && (this.allowRedirects = !1));
        let W = new re(o, c, Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, mr(i), P(i), i.component ?? i._loadedComponent ?? null, i, Rr(i)), A = dt(W, a, this.paramsInheritanceStrategy);
        return W.params = Object.freeze(A.params), W.data = Object.freeze(A.data), this.applyRedirects.applyRedirectCommands(m, i.redirectTo, S, W, n).pipe(U(ee => this.applyRedirects.lineralizeSegments(i, ee)), x(ee => this.processSegment(n, r, e, ee.concat(D), s, !1, a)));
    }
    matchSegmentAgainstRoute(n, e, r, i, o, s) {
        let a = Xi(e, r, i, n, this.urlSerializer);
        return r.path === "**" && (e.children = {}), a.pipe(U(u => u.matched ? (n = r._injector ?? n, this.getChildConfig(n, r, i).pipe(U(({ routes: c }) => {
            let m = r._loadedInjector ?? n, { parameters: S, consumedSegments: D, remainingSegments: W } = u, A = new re(D, S, Object.freeze(h({}, this.urlTree.queryParams)), this.urlTree.fragment, mr(r), P(r), r.component ?? r._loadedComponent ?? null, r, Rr(r)), It = dt(A, s, this.paramsInheritanceStrategy);
            A.params = Object.freeze(It.params), A.data = Object.freeze(It.data);
            let { segmentGroup: ee, slicedSegments: At } = vr(e, D, W, c);
            if (At.length === 0 && ee.hasChildren())
                return this.processChildren(m, c, ee, A).pipe(R(He => new T(A, He)));
            if (c.length === 0 && At.length === 0)
                return d(new T(A, []));
            let In = P(r) === o;
            return this.processSegment(m, c, ee, At, In ? f : o, !0, A).pipe(R(He => new T(A, He instanceof T ? [He] : [])));
        }))) : ue(e)));
    }
...
function lo(t, n) {
    return x(e => {
        let { targetSnapshot: r, guards: { canActivateChecks: i } } = e;
        if (!i.length)
            return d(e);
        let o = new Set(i.map(u => u.route)), s = new Set;
        for (let u of o)
            if (!s.has(u))
                for (let c of Yr(u))
                    s.add(c);
        let a = 0;
        return $(s).pipe(Ze(u => o.has(u) ? ho(u, r, t, n) : (u.data = dt(u, u.parent, t).resolve, d(void 0))), C(() => a++), Cr(1), x(u => a === s.size ? d(e) : G));
    });
}
...
function fo(t, n, e, r) {
    ...
    if (i.length === 0)
        return d({});
    let o = {};
    return $(i).pipe(x(s => po(t[s], n, e, r).pipe(oe(), C(a => {
        if (a instanceof Re)
            throw ft(new K, a);
        o[s] = a;
    }))), Cr(1), R(() => o), Ie(s => Wr(s) ? G : vt(s)));
}
...
var Jt = (() => {
    ...
    return t;
})(), V = new ie("", { providedIn: "root", factory: () => ({}) }), J = new ie(""), Rt = (() => {
    class t {
        ...
        loadComponent(e, r) {
            ...
            let i = H(_(e, () => r.loadComponent())).pipe(R(Jr), C(s => { this.onLoadEndListener && this.onLoadEndListener(r), r._loadedComponent = s; }), Dt(() => { this.componentLoaders.delete(r); })), o = new cr(i, () => new Ee).pipe(lr());
        ...
        loadChildren(e, r) {
            ...
            this.onLoadStartListener && this.onLoadStartListener(r);
            let o = Xr(r, this.compiler, e, this.onLoadEndListener).pipe(Dt(() => { this.childrenLoaders.delete(r); })), s = new cr(o, () => new Ee).pipe(lr());
...
function en(t, n, e) {
    let r = t.get(tr), i = t.get(An);
    if (!i.startViewTransition || r.skipNextTransition)
        return r.skipNextTransition = !1, new Promise(c => setTimeout(c));
    let o, s = new Promise(c => { o = c; }), a = i.startViewTransition(() => (o(), mo(t))), { onViewTransitionCreated: u } = r;
    return u && _(t, () => u({ transition: a, from: n, to: e })), s;
}
...
var St = new ie(""), ze = (() => {
    class t {
        ...
        setupNavigations(e) {
            return this.transitions = new N(null), this.transitions.pipe(le(r => r !== null), U(r => {
                let i = !1;
                return d(r).pipe(U(o => {
                    if (this.navigationId > r.id)
                        return this.cancelNavigationTransition(r, "", w.SupersededByNewNavigation), G;
                    this.currentTransition = r, this.currentNavigation = { id: o.id, initialUrl: o.rawUrl, extractedUrl: o.extractedUrl, targetBrowserUrl: typeof o.extras.browserUrl == "string" ? this.urlSerializer.parse(o.extras.browserUrl) : o.extras.browserUrl, trigger: o.source, extras: o.extras, previousNavigation: this.lastSuccessfulNavigation ? M(h({}, this.lastSuccessfulNavigation), { previousNavigation: null }) : null, abort: () => o.abortController.abort() };
                    let s = !e.navigated || this.isUpdatingInternalState() || this.isUpdatedBrowserUrl(), a = o.extras.onSameUrlNavigation ?? e.onSameUrlNavigation;
                    if (!s && a !== "reload") {
                        let u = "";
                        return this.events.next(new F(o.id, this.urlSerializer.serialize(o.rawUrl), u, pe.IgnoredSameUrlNavigation)), o.resolve(!1), G;
                    }
                    if (this.urlHandlingStrategy.shouldProcessUrl(o.rawUrl))
                        return d(o).pipe(U(u => (this.events.next(new Z(u.id, this.urlSerializer.serialize(u.extractedUrl), u.source, u.restoredState)), u.id !== this.navigationId ? G : Promise.resolve(u))), co(this.environmentInjector, this.configLoader, this.rootComponentType, e.config, this.urlSerializer, this.paramsInheritanceStrategy), C(u => { r.targetSnapshot = u.targetSnapshot, r.urlAfterRedirects = u.urlAfterRedirects, this.currentNavigation = M(h({}, this.currentNavigation), { finalUrl: u.urlAfterRedirects }); let c = new De(u.id, this.urlSerializer.serialize(u.extractedUrl), this.urlSerializer.serialize(u.urlAfterRedirects), u.targetSnapshot); this.events.next(c); }));
...
var Co = { paths: "exact", fragment: "ignored", matrixParams: "ignored", queryParams: "exact" }, wo = { paths: "subset", fragment: "ignored", matrixParams: "ignored", queryParams: "subset" }, L = (() => {
    class t {
        ...
        navigateToSyncWithBrowser(e, r, i) {
            let o = { replaceUrl: !0 }, s = i?.navigationId ? i : null;
            if (i) {
                let u = h({}, i);
                delete u.navigationId, delete u.ɵrouterPageId, Object.keys(u).length !== 0 && (o.state = u);
            }
            let a = this.parseUrl(e);
            this.scheduleNavigation(a, r, s, o).catch(u => { this.disposed || this.injector.get($n)(u); });
        }
        ...
        createUrlTree(e, r = {}) {
            let { relativeTo: i, queryParams: o, fragment: s, queryParamsHandling: a, preserveFragment: u } = r, c = u ? this.currentUrlTree.fragment : s, m = null;
        ...
        isActive(e, r) {
            let i;
            if (r === !0 ? i = h({}, Co) : r === !1 ? i = h({}, wo) : i = r, Y(e))
                return dr(this.currentUrlTree, e, i);
            let o = this.parseUrl(e);
            return dr(this.currentUrlTree, o, i);
        }
...
var bt = (() => {
    class t {
        ...
        subscribeToNavigationEventsIfNecessary() {
            if (this.subscription !== void 0 || !this.isAnchorElement)
                return;
            let e = this.preserveFragment, r = i => i === "merge" || i === "preserve";
            e ||= r(this.queryParamsHandling), e ||= !this.queryParamsHandling && !r(this.options?.defaultQueryParamsHandling), e && (this.subscription = this.router.events.subscribe(i => { i instanceof O && this.updateHref(); }));
        }
        preserveFragment = !1;
        ...
        onClick(e, r, i, o, s) {
            let a = this.urlTree;
            if (a === null || this.isAnchorElement && (e !== 0 || r || i || o || s || typeof this.target == "string" && this.target != "_self"))
                return !0;
            let u = { skipLocationChange: this.skipLocationChange, replaceUrl: this.replaceUrl, state: this.state, info: this.info };
            return this.router.navigateByUrl(a, u)?.catch(c => { this.applicationErrorHandler(c); }), !this.isAnchorElement;
        }
    ...
    class t {
        ...
        static ɵdir = l.ɵɵdefineDirective({ type: t, selectors: [["", "routerLinkActive", ""]], contentQueries: function (r, i, o) {
                if (r & 1 && l.ɵɵcontentQuery(o, bt, 5), r & 2) {
                    let s;
    ...
    class t {
        ...
        preloadConfig(e, r) {
            return this.preloadingStrategy.preload(r, () => {
                let i;
                r.loadChildren && r.canLoad === void 0 ? i = this.loader.loadChildren(e, r) : i = ae(null);
                let o = i.pipe($o(s => s === null ? ae(void 0) : (r._loadedRoutes = s.routes, r._loadedInjector = s.injector, this.processRoutes(s.injector ?? e, s.routes))));
...
function gn() {
    ...
    return n => {
        ...
        if (n !== e.components[0])
            return;
        let r = t.get(L), i = t.get(vn);
        t.get(ar) === 1 && r.initialNavigation(), t.get(yn, null, { optional: !0 })?.setUpPreloading(), t.get(sr, null, { optional: !0 })?.init(), r.resetRootComponentType(e.componentTypes[0]), i.closed || (i.next(), i.complete(), i.unsubscribe());
    };
}
...
var bn = [Ao, { provide: X, useClass: K }, L, se, { provide: q, useFactory: pn, deps: [L] }, Rt, []], Zo = (() => {
    class t {
        constructor() { }
